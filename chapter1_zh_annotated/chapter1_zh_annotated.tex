% 《几何群论答疑时间》第一讲“群”的中文注释版 / Annotated study edition, Chinese, of Office Hour One from
...
\newcommand{\bookpage}[3]{%
  ...
  \begin{textblock*}{380pt}(24pt,594pt)\footnotesize\sffamily\color{gray}
    第一讲，原书第 #2 页 \hfill 中文注释版\end{textblock*}%
}
% annotation column
\newcommand{\anncol}[1]{%
...
\newcommand{\interlude}[2]{%
  \begin{textblock*}{744pt}(24pt,20pt)
    {\sffamily\bfseries\large\color{big} 补充页：#1}\par\vspace{4pt}
...
\newtcolorbox{why}{enhanced,colback=why!5,colframe=why,boxrule=0.5pt,arc=2pt,
  ...
  title={\sffamily\bfseries 为什么？},fonttitle=\scriptsize,coltitle=white,colbacktitle=why,
...
\newtcolorbox{pitfall}{enhanced,colback=pit!5,colframe=pit,boxrule=0.5pt,arc=2pt,
  left=4pt,right=4pt,top=2pt,bottom=2pt,boxsep=1pt,fontupper=\small,
  title={\sffamily\bfseries 注意},fonttitle=\scriptsize,coltitle=white,colbacktitle=pit,
  attach boxed title to top left={xshift=4pt,yshift=-2pt},boxed title style={size=small,arc=1pt,boxrule=0pt}}
\newtcolorbox{tryit}{enhanced,colback=try!6,colframe=try,boxrule=0.5pt,arc=2pt,
  left=4pt,right=4pt,top=2pt,bottom=2pt,boxsep=1pt,fontupper=\small,
  title={\sffamily\bfseries 动手试},fonttitle=\scriptsize,coltitle=white,colbacktitle=try,
  attach boxed title to top left={xshift=4pt,yshift=-2pt},boxed title style={size=small,arc=1pt,boxrule=0pt}}
\newtcolorbox{lookahead}{enhanced,colback=ahead!5,colframe=ahead,boxrule=0.5pt,arc=2pt,
  left=4pt,right=4pt,top=2pt,bottom=2pt,boxsep=1pt,fontupper=\small,
  title={\sffamily\bfseries 前瞻},fonttitle=\scriptsize,coltitle=white,colbacktitle=ahead,
  attach boxed title to top left={xshift=4pt,yshift=-2pt},boxed title style={size=small,arc=1pt,boxrule=0pt}}
\newtcolorbox{bigpic}{enhanced,colback=big!5,colframe=big,boxrule=0.5pt,arc=2pt,
  left=4pt,right=4pt,top=2pt,bottom=2pt,boxsep=1pt,fontupper=\small,
  title={\sffamily\bfseries 大局},fonttitle=\scriptsize,coltitle=white,colbacktitle=big,
  attach boxed title to top left={xshift=4pt,yshift=-2pt},boxed title style={size=small,arc=1pt,boxrule=0pt}}
\newtcolorbox{prereq}{enhanced,colback=gray!8,colframe=gray!60!black,boxrule=0.5pt,arc=2pt,
  left=4pt,right=4pt,top=2pt,bottom=2pt,boxsep=1pt,fontupper=\small,
  title={\sffamily\bfseries 预备知识},fonttitle=\scriptsize,coltitle=white,colbacktitle=gray!60!black,
  attach boxed title to top left={xshift=4pt,yshift=-2pt},boxed title style={size=small,arc=1pt,boxrule=0pt}}
...
\begin{tikzpicture}[node distance=1.6cm,>={Stealth[length=4pt]}]
  ...
  \draw[->,thick] (y) -- node[above,font=\scriptsize] {再做 $g$} (z);
...
{\sffamily\bfseries\huge 第一讲：群}\par\vspace{4pt}
{\sffamily\Large 中文注释学习版}\par\vspace{6pt}
{\large 原书章节：Matt Clay 与 Dan Margalit，\emph{Office Hours with a Geometric Group Theorist}（普林斯顿大学出版社，2017），第 3--20 页。}\par
\vspace{14pt}
\begin{minipage}[t]{385pt}
{\sffamily\bfseries\large 怎样读这份材料}\par\vspace{4pt}
每一跨页的左边是原书的一页，保持原样；右边是一栏注释。页面上橙色的编号标记 \num{1}\,\num{2}\,\num{3} 指向注释所针对的那一行；
需要精确定位时，淡黄色的色条会标出原文中的那句话。
%
注释面向基础扎实的高中读者：补足作者默认你已掌握的背景（函数、同余运算、矩阵），为每一个构造画出图形，
把例子完整算一遍，并给出全部十三道习题的提示。

\vspace{6pt}
{\sffamily\bfseries\large 各色方框的含义}\par\vspace{2pt}
\begin{tabular}{@{}ll@{}}
\textcolor{big}{\rule{8pt}{8pt}} 大局 & 这个想法在全书中所处的位置\\
\textcolor{why}{\rule{8pt}{8pt}} 为什么？& 某个定义或论断成立的理由\\
\textcolor{pit}{\rule{8pt}{8pt}} 注意 & 常见的误读，或原文中的疏漏\\
\textcolor{try}{\rule{8pt}{8pt}} 动手试 & 需要自己动手验算的内容，以及习题提示\\
\textcolor{ahead}{\rule{8pt}{8pt}} 前瞻 & 与后面各讲的联系\\
\textcolor{gray!60!black}{\rule{8pt}{8pt}} 预备知识 & 正文默认你已知道的中学数学事实\\
\end{tabular}

\vspace{10pt}
{\sffamily\bfseries\large 本讲内容}\par\vspace{2pt}
\begin{tabular}{@{}lll@{}}
对称、正方体与 $S_4$ & 原书第 3--5 页 & 跨页 1--3、A2--A5\\
1.1 群：$D_n$、$S_n$、$\Z/n\Z$ & 原书第 5--9 页 & 跨页 3--7、B、B2\\
1.2 无限群：$\Z$、$\Z^2$、矩阵群、自由群 & 原书第 9--13 页 & 跨页 7--11\\
1.3 同态与正规子群 & 原书第 13--17 页 & 跨页 11--15\\
1.4 群的表现 & 原书第 17--20 页 & 跨页 15--18\\
图示页 V1--V5 & --- & 穿插在各跨页之间\\
全章地图、习题提示、术语表 & --- & 末尾几页\\
\end{tabular}
\end{minipage}\hfill
...
\begin{bigpic}
\textbf{请记住这一句话。} 整章都在论证一件事：“群”与“某个东西的全部对称”是同一个想法的两面。
每个例子都出现两次：一次作为带乘法的集合，一次作为你能亲手draw it的图形的对称。
第二讲把这件事变成一条定理（每个群都是它自己的凯莱图的对称群）。
\end{bigpic}
\begin{prereq}
如果下面这些词对你已经有意义，本章会读得顺畅得多：
\emph{函数}、\emph{双射}（既单又满）、\emph{复合} $g\circ h$（先做 $h$）、
被 $n$ 除所得的\emph{余数}、\emph{向量加法}、$2\times2$ \emph{行列式}以及 $\det(MN)=\det M\,\det N$ 这一事实。
正文第一次用到时，每一条都会在灰色方框里复习一遍。
\end{prereq}
\vspace{6pt}
\centering \figtriangle\par
{\scriptsize 本章略去的热身：等边三角形有 6 个对称，它们的行为与其 3 个顶点的 6 个置换完全一致。}
\end{minipage}
\end{textblock*}
\mbox{}\clearpage
...
\anncol{
\A{1}{“确定物体的对称”}
一个物体的\emph{对称}，是指一种移动它的方式，移动之后它看上去与先前一模一样。
全书赖以建立的关键在于：对称可以\emph{复合}（先做一个，再做另一个），也可以\emph{撤销}。
“群”这个词打包的正是这两条性质。

\begin{prereq}
\emph{函数} $f:X\to Y$ 给每个输入指定唯一一个输出。若 $Y$ 中每个元素都恰好被取到一次，就称它为\emph{双射}；这时它有逆 $f\inv$。
\emph{复合} $g\circ h$ 的意思是“先作用 $h$，再作用 $g$”。对称是物体到它自身的双射，所以上面这些说法对它们都适用。
\end{prereq}

\A{2}{前两讲的路线}
第一讲（本章）走一个方向：从熟悉的群出发，逐个说明它是某幅图形的对称的集合。
第二讲走相反的方向，并在一般情形下加以证明。
“它们之间的相互作用”这句话正是几何群论的主题：用几何对象的形状去了解群的代数，反过来也一样。

\begin{bigpic}
边读边记一张表。对本章遇到的每个群，写下 (a) 集合，(b) 乘法，(c) 它是什么东西的对称。
读完时你大约会有十行。那张表\emph{就是}本章的内容。
\end{bigpic}

\A{3}{正方体}
本章第一个完整例子。翻页之前先自己回答这个问题：你能用多少种方式把一个正方体拿起来、转一转、再放回去，使它占据同一块空间？
（允许转动，不允许镜像翻转。）把你能找到的都数一数；下一页会说明一共有 24 个，更要紧的是解释这 24 个“是”什么。

\begin{tryit}
对画在纸上的正方形做同样的事，只允许转动纸张：你会数出 4 个。再允许翻面就是 8 个。这两个答案会在原书第 6 页以 $\Z/4\Z$ 和 $D_4$ 的形式重新出现。
\end{tryit}
}
...
\anncol{
\A{1}{“刚体变换，不含反射”}
刚体的意思是保持距离：正方体是作为一个整体被搬动的，不会被压扁。
排除反射，是因为你无法用双手做出镜像；你\emph{能够}亲手做出的变换叫作\emph{保定向}的。
若允许反射，个数会翻倍到 48。

\A{2}{$8\times3=24$ 这个计数}
固定一个顶点 $A$。任何对称必须把 $A$ 送到 8 个顶点之一。一旦知道 $A$ 去了哪里，正方体仍可绕过该顶点的长对角线自转，恰好有 3 个位置（转 $0^\circ$、$120^\circ$、$240^\circ$）能对上。每个对称都由这两次选择确定，所以共有 $8\cdot 3=24$ 个。
紧接着那句抱怨才是要点：数出来不等于理解。我们想知道的是这 24 个怎样复合。

\A{3}{四条长对角线}
长对角线连接一个顶点与它的对顶点，穿过正方体的中心。标有字母的图见两个跨页之后的补充页 A2：$d_1=AG$、$d_2=BH$、$d_3=CE$、$d_4=DF$。

\A{4}{那两条事实}
\emph{第一条。} 对称把顶点送到顶点，并且保持对顶关系，因此它把每条长对角线送到一条长对角线；这就是对 $\{d_1,d_2,d_3,d_4\}$ 的一次重排（置换）。

\emph{第二条中的存在性。} 取两条对角线，比如 $d_1=AG$ 与 $d_2=BH$。棱 $AB$ 各连着它们的一个端点，对棱 $GH$ 也是如此。绕过 $AB$ 与 $GH$ 中点的轴转 $180^\circ$，会交换 $A\leftrightarrow B$ 与 $G\leftrightarrow H$，于是交换 $d_1\leftrightarrow d_2$，并保持另外两条不动。所以每一个“交换两条对角线”都能实现；而任何置换都是若干次交换的乘积（原书第 7 页），因此每个置换都能实现。

\begin{why}
\emph{唯一性}在原文中是靠计数悄悄带过的：映射 $\{\text{对称}\}\to\{\text{4 条对角线的置换}\}$ 是满的，两边各有 24 个元素，所以它bijective。直接的论证见补充页 A7：固定全部四条对角线的旋转只有恒等。
\end{why}

\A{5}{“串过两条棱的中点”}
这就是补充页 A4 画出的棱轴半转，也列在补充页 B2 的对照表里。对棱共有 6 对，给出 $S_4$ 的 6 个对换。

\A{6}{$4!=24$ 与复合}
$4!=4\cdot3\cdot2\cdot1$ 数的是把 4 个东西排成一列的方法数：$d_1$ 的去处有 4 种选择，然后 3 种、2 种、1 种。
最后一句才是真正的回报：既然置换是函数，“先做一个对称再做另一个”就变成了“复合两个函数”，而这完全是机械的。正方体的对称不再是 24 个动作的一堆，而成了一个有结构的对象 $S_4$。
}

% ================================================================ INTERLUDE A2 (face axis)
\interlude{A2. 面轴：每条轴上各有三次转动}{
\begin{minipage}[t]{744pt}\vspace{0pt}
\begin{minipage}[t]{530pt}\vspace{0pt}\small
每次转动都用三种方式呈现。左边是\emph{转动前}的正方体（每个字母都在自己的顶点上）与\emph{转动后}的正方体（每个字母画在它所移动到的那个顶点上）。每个顶点有自己的颜色，字母随顶点一起走，所以只要看某个色盘离它的灰色字母有多远，就知道它移动了多少。右边是沿该轴俯视所见的图，转动前与转动后并排。
\end{minipage}\hfill
...
\begin{tikzpicture}[scale=0.5,line join=round]
  ...
  \node[font=\small\bfseries] at (2.15,-1.0) {3 条面轴};
  \node[font=\scriptsize,align=center,text width=6.4cm] at (2.15,-2.1) {上下、左右、前后；每条都连接一对对面的中心。每条轴上有三次转动：$3\cdot3=9$ 次。};
\end{tikzpicture}
...
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (5.4,2.15) -- node[above,font=\scriptsize,mkc,align=center] {四分之一转\\$90^\circ$} (7.0,2.15);
...
\end{scope}
  \node[font=\scriptsize,anchor=north west] at (-0.6,-0.7) {之前};
  \node[font=\scriptsize,anchor=north west] at (7.0,-0.7) {之后};
...
\begin{scope}[shift={(22.2,2.15)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=brown!80!black!30,draw=brown!80!black,thick,text=black] at (-1.55,1.55) {$G$};
\end{scope}
  \node[font=\scriptsize,anchor=north] at (18.9,-0.7) {沿该轴俯视：之前 $\to$ 之后};
  \node[font=\scriptsize,align=left,text width=8.6cm,anchor=north west] at (25.2,4.9) {\textbf{四分之一转，$90^\circ$。} 底面的每个顶点都沿圈挪一位，$A\to B\to F\to E\to A$，顶面也一样，$D\to C\to G\to H\to D$。对角线：$d_1\to d_2\to d_4\to d_3\to d_1$，一个四轮换。\emph{俯视图}沿面轴从顶面上方往下看：正方形 $DCGH$；$A,B,F,E$ 分别藏在 $D,C,G,H$ 下面，轴就是中心那个橙点。四种颜色组成的环整体转过四分之一。};
\begin{scope}[shift={(0,-8.6)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (1.3,4.3) {$H$};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (5.4,-6.45) -- node[above,font=\scriptsize,mkc,align=center] {半转\\$180^\circ$} (7.0,-6.45);
...
\end{scope}
  \node[font=\scriptsize,anchor=north west] at (-0.6,-9.3) {之前};
  \node[font=\scriptsize,anchor=north west] at (7.0,-9.3) {之后};
...
\begin{scope}[shift={(22.2,-6.45)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (-1.55,1.55) {$C$};
\end{scope}
  \node[font=\scriptsize,anchor=north] at (18.9,-9.3) {沿该轴俯视：之前 $\to$ 之后};
  \node[font=\scriptsize,align=left,text width=8.6cm,anchor=north west] at (25.2,-3.7) {\textbf{半转，$180^\circ$。} 每个顶点都跳到它所在面的对角顶点：$A\leftrightarrow F$、$B\leftrightarrow E$、$C\leftrightarrow H$、$D\leftrightarrow G$。对角线：$(d_1\,d_4)(d_2\,d_3)$，两个不相交的对换。\emph{俯视图}沿面轴从顶面上方往下看：正方形 $DCGH$；$A,B,F,E$ 分别藏在 $D,C,G,H$ 下面，轴就是中心那个橙点。每种颜色都走到正方形上正对面的顶点。};
\begin{scope}[shift={(0,-17.2)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (1.3,4.3) {$H$};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (5.4,-15.05) -- node[above,font=\scriptsize,mkc,align=center] {四分之三转\\$270^\circ$} (7.0,-15.05);
...
\end{scope}
  \node[font=\scriptsize,anchor=north west] at (-0.6,-17.9) {之前};
  \node[font=\scriptsize,anchor=north west] at (7.0,-17.9) {之后};
...
\begin{scope}[shift={(22.2,-15.05)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (-1.55,1.55) {$D$};
\end{scope}
  \node[font=\scriptsize,anchor=north] at (18.9,-17.9) {沿该轴俯视：之前 $\to$ 之后};
  \node[font=\scriptsize,align=left,text width=8.6cm,anchor=north west] at (25.2,-12.3) {\textbf{四分之三转，$270^\circ$（$=-90^\circ$）。} 就是反方向的四分之一转：每个顶点都朝相反方向走，$A\to E\to F\to B\to A$，$D\to H\to G\to C\to D$。对角线：$d_1\to d_3\to d_4\to d_2\to d_1$，是前一个四轮换的逆。\emph{俯视图}沿面轴从顶面上方往下看：正方形 $DCGH$；$A,B,F,E$ 分别藏在 $D,C,G,H$ 下面，轴就是中心那个橙点。环朝另一方向转过四分之一；这正是表中写 $\pm90^\circ$ 的原因。};
\end{tikzpicture}
\end{minipage}
}

% ================================================================ INTERLUDE A3 (long diagonal)
\interlude{A3. 长对角线：每条轴上各有两次转动，以及为什么没有第三种}{
\begin{minipage}[t]{744pt}\vspace{0pt}
\begin{minipage}[t]{530pt}\vspace{0pt}\small
轴是斜的时候，正方体画成立在该轴所穿过的那个顶点上，于是轴是竖直的，和上一页完全一样。颜色约定相同，三种视图也相同。右边那个正方体标出了全部四条长对角线；下面各行用的是 $AG$，也就是 $d_1$。第三行展示转 $60^\circ$，它\emph{不是}对称，用来解释为什么每条轴上只数到两次。
\end{minipage}\hfill
\begin{minipage}[t]{200pt}\vspace{0pt}\centering
\begin{tikzpicture}[scale=0.5,line join=round]
  \draw[thick] (0,0)--(3,0)--(3,3)--(0,3)--cycle; \draw[thick] (3,0)--(4.3,1.3)--(4.3,4.3)--(3,3); \draw[thick] (0,3)--(1.3,4.3)--(4.3,4.3);
  ...
  \node[font=\small\bfseries] at (2.15,-1.0) {4 条长对角线};
  \node[font=\scriptsize,align=center,text width=6.4cm] at (2.15,-2.1) {每条都穿过中心连接两个对顶点。每条轴上有两次转动：$4\cdot2=8$ 次。};
\end{tikzpicture}
\end{minipage}\par\vspace{4pt}
...
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (5.4,2.15) -- node[above,font=\scriptsize,mkc,align=center] {三分之一转\\$120^\circ$} (7.0,2.15);
\begin{scope}[shift={(7.6,0)}]
  \draw[thick] (2.15,-0.002)--(3.67,1.34);
  \draw[thick] (2.15,-0.002)--(-0.007,1.34);
  \draw[thick] (2.15,-0.002)--(2.787,1.818);
...
\end{scope}
  \node[font=\scriptsize,anchor=north] at (18.9,-0.7) {沿该轴俯视：之前 $\to$ 之后};
  \node[font=\scriptsize,align=left,text width=8.6cm,anchor=north west] at (25.2,4.9) {\textbf{三分之一转，$120^\circ$，绕长对角线 $AG$。} 正方体立在 $A$ 上，所以轴是竖直的；$A$ 与 $G$ 不动。下环转过一位，$B\to D\to E\to B$，上环也一样，$C\to H\to F\to C$。对角线：$d_1$ 不动，$d_2\to d_4\to d_3\to d_2$，一个三轮换。\emph{俯视图}沿对角线 $AG$ 从 $G$ 上方往下看：一个正六边形，$G$ 在中心而 $A$ 藏在它下面；实线辐条通向 $G$ 的邻点 $C,F,H$，虚线辐条通向 $A$ 的邻点 $B,D,E$。由颜色组成的六边形整体转过三分之一。};
\begin{scope}[shift={(0,-8.0)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (0.63,3.16) {$H$};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (5.4,-5.85) -- node[above,font=\scriptsize,mkc,align=center] {三分之二转\\$240^\circ$} (7.0,-5.85);
...
\end{scope}
  \node[font=\scriptsize,anchor=north west] at (-0.6,-8.7) {之前};
  \node[font=\scriptsize,anchor=north west] at (7.0,-8.7) {之后};
...
\begin{scope}[shift={(22.2,-5.85)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=brown!80!black!30,draw=brown!80!black,thick,text=black] at (0,0) {$G$};
\end{scope}
  \node[font=\scriptsize,anchor=north] at (18.9,-8.7) {沿该轴俯视：之前 $\to$ 之后};
  \node[font=\scriptsize,align=left,text width=8.6cm,anchor=north west] at (25.2,-3.1) {\textbf{三分之二转，$240^\circ$（$=-120^\circ$）。} 就是反方向的三分之一转。下环 $B\to E\to D\to B$，上环 $C\to F\to H\to C$。对角线：$d_1$ 不动，$d_2\to d_3\to d_4\to d_2$，是前一个三轮换的逆。\emph{俯视图}沿对角线 $AG$ 从 $G$ 上方往下看：一个正六边形，$G$ 在中心而 $A$ 藏在它下面；实线辐条通向 $G$ 的邻点 $C,F,H$，虚线辐条通向 $A$ 的邻点 $B,D,E$。六边形朝另一方向转过三分之一；这正是表中写 $\pm120^\circ$ 的原因。};
\begin{scope}[shift={(0,-16.0)}]
  \draw[thick] (2.150,-0.002)--(3.670,1.340);
  \draw[thick] (2.150,-0.002)--(-0.007,1.340);
  \draw[thick] (2.150,-0.002)--(2.787,1.818);
  \draw[thick,dashed,gray] (3.670,1.340)--(1.513,2.682);
  \draw[thick] (3.670,1.340)--(4.307,3.160);
  \draw[thick,dashed,gray] (-0.007,1.340)--(1.513,2.682);
  \draw[thick] (-0.007,1.340)--(0.630,3.160);
  \draw[thick] (2.787,1.818)--(4.307,3.160);
  \draw[thick] (2.787,1.818)--(0.630,3.160);
  \draw[thick,dashed,gray] (1.513,2.682)--(2.150,4.502);
  \draw[thick] (4.307,3.160)--(2.150,4.502);
  \draw[thick] (0.630,3.160)--(2.150,4.502);
  \draw[very thick,mkc] (2.15,-0.7)--(2.15,5.3);
  \draw[-{Stealth[length=4pt]},mkc,thick] (3.25,3.952) arc (0:120:1.1 and 0.4);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (2.150,-0.002) {$A$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=orange!95!black!30,draw=orange!95!black,thick,text=black] at (3.670,1.340) {$B$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (1.513,2.682) {$C$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (-0.007,1.340) {$D$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=violet!30,draw=violet,thick,text=black] at (2.787,1.818) {$E$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=cyan!65!black!30,draw=cyan!65!black,thick,text=black] at (4.307,3.160) {$F$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=brown!80!black!30,draw=brown!80!black,thick,text=black] at (2.150,4.502) {$G$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (0.630,3.160) {$H$};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (5.4,-13.85) -- node[above,font=\scriptsize,mkc,align=center] {转\\$60^\circ$} (7.0,-13.85);
\begin{scope}[shift={(7.6,-16.0)}]
  \draw[thick] (2.150,-0.002)--(4.307,1.659);
  \draw[thick,dashed,gray] (2.150,-0.002)--(1.513,1.181);
  \draw[thick] (2.150,-0.002)--(0.630,1.659);
  \draw[thick] (4.307,1.659)--(3.670,2.842);
  \draw[thick] (4.307,1.659)--(2.787,3.319);
  \draw[thick,dashed,gray] (1.513,1.181)--(3.670,2.842);
  \draw[thick,dashed,gray] (1.513,1.181)--(-0.007,2.842);
  \draw[thick] (0.630,1.659)--(2.787,3.319);
  \draw[thick] (0.630,1.659)--(-0.007,2.842);
  \draw[thick] (3.670,2.842)--(2.150,4.502);
  \draw[thick] (2.787,3.319)--(2.150,4.502);
  \draw[thick] (-0.007,2.842)--(2.150,4.502);
  \draw[very thick,mkc] (2.15,-0.7)--(2.15,5.3);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (2.150,-0.002) {$A$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=orange!95!black!30,draw=orange!95!black,thick,text=black] at (4.307,1.659) {$B$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (3.670,2.842) {$C$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (1.513,1.181) {$D$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=violet!30,draw=violet,thick,text=black] at (0.630,1.659) {$E$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=cyan!65!black!30,draw=cyan!65!black,thick,text=black] at (2.787,3.319) {$F$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=brown!80!black!30,draw=brown!80!black,thick,text=black] at (2.150,4.502) {$G$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=10pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (-0.007,2.842) {$H$};
\end{scope}
  \node[font=\scriptsize,anchor=north west] at (-0.6,-16.7) {之前};
  \node[font=\scriptsize,anchor=north west] at (7.0,-16.7) {转 $60^\circ$ 之后：正方体本身移动了，与上面两行不同};
  \node[font=\scriptsize,align=left,text width=14.5cm,anchor=north west] at (14.0,-11.1) {\textbf{为什么 $60^\circ$ 不行？} 只把正方体转 $60^\circ$，它\emph{不会}落回自身：把“之后”那幅图与上面两行对照，上面两行里正方体最终占据的正是它出发时那块空间，只有字母动了。这里则是正方体本身挪了位，所以没有任何顶点落在顶点上。原因在于高度。沿着这条轴，外围六个顶点分处两个环上：上环 $C,F,H$ 在三分之一高处，下环 $B,D,E$ 在三分之二高处，而绕六边形一周时两个环交替出现。转 $60^\circ$ 把每个顶点沿六边形挪一位，从上环的位置挪到下环的位置，高度不对。转 $120^\circ$ 挪两位，环到同一个环。（从上方看，转 $60^\circ$ 后轮廓仍然吻合，这正是只看俯视图会被误导的原因：它把高度藏起来了。）};
\end{tikzpicture}
\par\vspace{6pt}
\begin{minipage}[t]{744pt}\vspace{0pt}\raggedright
\begin{pitfall}\footnotesize
还有两种方式可以看出只有 $120^\circ$ 与 $240^\circ$ 行得通：沿轴直视，交于近端顶点的三条棱在六边形内构成一个 Y 形，而 Y 形只有 3 重对称；另外，绕该轴的旋转必须把三个顶点组成的上环映到自身，所以只能是 $360^\circ/3$ 的倍数。把转 $60^\circ$ \emph{再配上}关于轴中部那张平面的反射，确实能把正方体映到自身，但那是镜像型的对称，你无法靠转动正方体做出来，所以它不在这 24 个旋转之列；若允许镜像，这个群有 48 个元素（见补充页 B2）。
\end{pitfall}
\end{minipage}
\end{minipage}
}
...
\interlude{A4. 棱轴：每条轴上各有一次转动}{
\begin{minipage}[t]{744pt}\vspace{0pt}
\begin{minipage}[t]{530pt}\vspace{0pt}\small
棱轴连接一对对棱的中点。正方体画成立在那条棱上，于是轴是竖直的。颜色约定相同，三种视图也相同。右边那个正方体标出了全部六条棱轴，并把十二个棱中点画成圆点；下面一行用的是穿过 $AB$ 与 $GH$ 中点的那条轴。
\end{minipage}\hfill
\begin{minipage}[t]{200pt}\vspace{0pt}\centering
\begin{tikzpicture}[scale=0.5,line join=round]
  \draw[thick] (0,0)--(3,0)--(3,3)--(0,3)--cycle; \draw[thick] (3,0)--(4.3,1.3)--(4.3,4.3)--(3,3); \draw[thick] (0,3)--(1.3,4.3)--(4.3,4.3);
  ...
  \node[font=\small\bfseries] at (2.15,-1.0) {6 条棱轴};
  \node[font=\scriptsize,align=center,text width=6.4cm] at (2.15,-2.1) {每条都连接一对对棱的中点；12 条棱构成 6 对对棱。每条轴上一次转动：$6$ 次。};
\end{tikzpicture}
\end{minipage}\par\vspace{4pt}
\begin{tikzpicture}[scale=0.58,line join=round]
\begin{scope}[shift={(0,0)}]
...
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (5.4,2.15) -- node[above,font=\scriptsize,mkc,align=center] {半转\\$180^\circ$} (7.0,2.15);
\begin{scope}[shift={(7.6,0)}]
  \draw[thick] (0.75,0.07)--(3.55,0.07);
  \draw[thick] (0.75,0.07)--(1.344,2.347);
  \draw[thick] (3.55,0.07)--(4.144,2.347);
...
\end{scope}
  \node[font=\scriptsize,anchor=north] at (18.9,-0.7) {沿该轴俯视：之前 $\to$ 之后};
  \node[font=\scriptsize,align=left,text width=8.6cm,anchor=north west] at (25.2,4.9) {\textbf{半转，$180^\circ$，绕一条棱轴。} 该轴穿过对棱 $AB$ 与 $GH$ 的中点（图中的圆点），正方体立在棱 $AB$ 上。每个顶点都与一个伙伴互换：$A\leftrightarrow B$、$G\leftrightarrow H$、$C\leftrightarrow E$、$D\leftrightarrow F$。对角线：只有 $d_1\leftrightarrow d_2$，一次对换。\emph{俯视图}沿棱轴从 $GH$ 上方往下看：$1\times\sqrt2$ 的矩形 $CDEF$；$G,H$ 位于长边上，$B,A$ 分别藏在它们下面。半转把每种颜色送到正对面的位置，再做一次半转就全部归位。};
\end{tikzpicture}
\end{minipage}
}

% ================================================================ INTERLUDE A5 (reading guide)
\interlude{A5. 三类轴合在一起，以及这些图该怎么读}{
\begin{minipage}[t]{744pt}\vspace{0pt}
\small
\begin{center}
\begin{tabular}{@{}lccc@{}}
\toprule
轴的种类 & 有几条轴 & 每条轴上的转动次数 & 转动总数\\
\midrule
穿过一对对面的中心 & 3 & 3（$90^\circ,180^\circ,270^\circ$） & 9\\
穿过一对对顶点（长对角线） & 4 & 2（$120^\circ,240^\circ$） & 8\\
穿过一对对棱的中点 & 6 & 1（$180^\circ$） & 6\\
\midrule
再加上恒等 & & & 1\\
合计 & & & 24\\
\bottomrule
...
\begin{why}
怎样从一对“之前／之后”的图里读出对角线的去向：对角线由它的两个端点命名，所以要看这两个端点各自去了哪里。在四分之一转中，$A$ 现在坐在 $B$ 原来的顶点上，$G$ 坐在 $H$ 的顶点上，所以对角线 $d_1=AG$ 现在占据了 $BH=d_2$ 的位置。同样地，$B,H$ 去了 $F,D$ 的顶点，所以 $d_2$ 占据 $d_4$ 的位置；如此沿着这个四轮换转下去。在棱轴半转中，$C$ 与 $E$ 互换了，所以对角线 $CE=d_3$ 仍占据自己的位置，只是掉了个头：作为一条对角线它是不动的。
\end{why}
\begin{why}
为什么 $270^\circ$ 与 $240^\circ$ 在表中写成“$-90^\circ$”和“$-120^\circ$”：朝一个方向转 $270^\circ$，正方体落到的位置与朝另一个方向转 $90^\circ$ 完全相同，所以它们是同一个对称，即四分之一转的逆，每个顶点的移动都反了向。这就是表中写 $\pm90^\circ$ 与 $\pm120^\circ$、并且每条轴算两次转动的原因。半转是它自己的逆，所以只算一次。
\end{why}
\end{minipage}\hfill
\begin{minipage}[t]{360pt}\vspace{0pt}\raggedright
\begin{pitfall}
同一类转动，换一条轴，置换就不同。图中画的四分之一转是绕上下轴的，给出四轮换 $(d_1\,d_2\,d_4\,d_3)$；绕前后轴的四分之一转给出另一个四轮换。四分之一转一共有 6 个（3 条轴、2 个方向），而 $S_4$ 中恰有 6 个四轮换：一一对应。逐行都是这样的对应：3 个半转对 3 个双对换，8 个三分之一转对 8 个三轮换，6 个棱轴转动对 6 个单对换。
\end{pitfall}
\begin{tryit}
先做 $120^\circ$ 那幅图，再做 $240^\circ$ 那幅，把第一幅的“之后”当作第二幅的“之前”：每种颜色都回到原位。三分之一加三分之二正好是一整圈，在 $S_4$ 中就是 $(d_2\,d_3\,d_4)(d_2\,d_4\,d_3)=()$。然后试试四分之一转接棱轴半转，看看结果属于那 24 行中的哪一行。
\end{tryit}
\end{minipage}
\end{minipage}
}

% ================================================================ INTERLUDE A6 (page 4: the map to permutations)
\interlude{A6. 原书第 4 页，第一条事实：每个对称都重排这四条长对角线}{
\begin{minipage}[t]{744pt}\vspace{0pt}
\small
按前几页的方式给顶点标上 $A,\dots,H$，并记 $d_1=AG$、$d_2=BH$、$d_3=CE$、$d_4=DF$。对正方体的一个对称 $g$，记 $\Phi(g)$ 为它在 $\{d_1,d_2,d_3,d_4\}$ 上给出的重排。本页证明原书两条事实中的第一条，即 $\Phi(g)$ 确实有意义，并记下 $\Phi$ 的一条性质，下一页会用到两次。\par\vspace{4pt}
\begin{minipage}[t]{368pt}\vspace{0pt}
{\sffamily\bfseries\color{big} 为什么对角线一定变成对角线}\par\vspace{2pt}
对称把正方体映到自身，所以它把八个顶点映到八个顶点。它还\emph{固定中心}：中心是八个顶点的平均，刚体运动把平均送到平均，而八个顶点整体被映到自身。\par\vspace{2pt}
现在，两个顶点 $P,P'$ 互为对顶，当且仅当中心是线段 $PP'$ 的中点；“对顶”正是这个意思。对它施加 $g$。$g(P)g(P')$ 的中点是 $PP'$ 中点的像，因为刚体运动把中点送到中点。而那个像就是中心的像，也就是中心。所以 $g(P)$ 与 $g(P')$ 也互为对顶。\par\vspace{2pt}
于是 $g$ 把每条长对角线映到一条长对角线；又因为 $g$ 在顶点上是一一的，它在对角线上也是一一的。所以 $\Phi(g)$ 确实是四条对角线的一个置换，这就是第一条事实。\par\nobreak\vspace{3pt}
\centerline{\begin{tikzpicture}[scale=0.66]
  \draw[thick,gray!70!black] (0.00,0.00)--(3.00,0.00);
  \draw[thick,gray!70!black] (3.00,0.00)--(3.00,3.00);
  \draw[thick,gray!70!black] (3.00,3.00)--(0.00,3.00);
  \draw[thick,gray!70!black] (0.00,3.00)--(0.00,0.00);
  \draw[thick,gray!70!black] (3.00,0.00)--(4.30,1.30);
  \draw[thick,gray!70!black] (4.30,1.30)--(4.30,4.30);
  \draw[thick,gray!70!black] (4.30,4.30)--(3.00,3.00);
  \draw[thick,gray!70!black] (0.00,3.00)--(1.30,4.30);
  \draw[thick,gray!70!black] (1.30,4.30)--(4.30,4.30);
  \draw[thick,dashed,gray!55] (0.00,0.00)--(1.30,1.30);
  \draw[thick,dashed,gray!55] (1.30,1.30)--(4.30,1.30);
  \draw[thick,dashed,gray!55] (1.30,1.30)--(1.30,4.30);
  \draw[very thick,red!80!black] (0.00,0.00)--(4.30,4.30);
  \fill[mkc] (2.15,2.15) circle (3pt);
  \node[font=\tiny,mkc,anchor=north east,inner sep=3.5pt] at (2.15,2.15) {中心};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=red!80!black!25,draw=red!80!black,thick,text=black] at (0.00,0.00) {$A$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (3.00,0.00) {$B$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (3.00,3.00) {$C$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (0.00,3.00) {$D$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (1.30,1.30) {$E$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (4.30,1.30) {$F$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=red!80!black!25,draw=red!80!black,thick,text=black] at (4.30,4.30) {$G$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (1.30,4.30) {$H$};
  \node[font=\scriptsize,red!80!black,anchor=south] at (2.15,4.95) {$d_1=AG$};
  \node[font=\scriptsize,align=center,anchor=north,text width=150pt] at (2.15,-0.75) {\textbf{之前}：中心是 $AG$ 的中点，这正是 $A$ 与 $G$ 互为对顶的含义};
  \draw[-{Stealth[length=6pt]},very thick,mkc] (5.7,2.15)--node[above,font=\scriptsize,mkc,align=center]{施加 $h$，即绕竖直轴\\转四分之一圈}(9.9,2.15);
  \draw[thick,gray!70!black] (11.10,0.00)--(14.10,0.00);
  \draw[thick,gray!70!black] (14.10,0.00)--(14.10,3.00);
  \draw[thick,gray!70!black] (14.10,3.00)--(11.10,3.00);
  \draw[thick,gray!70!black] (11.10,3.00)--(11.10,0.00);
  \draw[thick,gray!70!black] (14.10,0.00)--(15.40,1.30);
  \draw[thick,gray!70!black] (15.40,1.30)--(15.40,4.30);
  \draw[thick,gray!70!black] (15.40,4.30)--(14.10,3.00);
  \draw[thick,gray!70!black] (11.10,3.00)--(12.40,4.30);
  \draw[thick,gray!70!black] (12.40,4.30)--(15.40,4.30);
  \draw[thick,dashed,gray!55] (11.10,0.00)--(12.40,1.30);
  \draw[thick,dashed,gray!55] (12.40,1.30)--(15.40,1.30);
  \draw[thick,dashed,gray!55] (12.40,1.30)--(12.40,4.30);
  \draw[very thick,blue!70!black] (14.10,0.00)--(12.40,4.30);
  \fill[mkc] (13.25,2.15) circle (3pt);
  \node[font=\tiny,mkc,anchor=north east,inner sep=3.5pt] at (13.25,2.15) {中心};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (11.10,0.00) {$A$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=blue!70!black!25,draw=blue!70!black,thick,text=black] at (14.10,0.00) {$B$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (14.10,3.00) {$C$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (11.10,3.00) {$D$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (12.40,1.30) {$E$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (15.40,1.30) {$F$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!10,draw=gray!55!black,thick,text=black] at (15.40,4.30) {$G$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=blue!70!black!25,draw=blue!70!black,thick,text=black] at (12.40,4.30) {$H$};
  \node[font=\scriptsize,blue!70!black,anchor=south] at (13.25,4.95) {$d_2=BH$};
  \node[font=\scriptsize,align=center,anchor=north,text width=150pt] at (13.25,-0.75) {\textbf{之后}：$h$ 把 $A$ 送到 $B$、$G$ 送到 $H$，而中心原地未动，所以中心现在是 $BH$ 的中点};
\end{tikzpicture}
}\par\vspace{2pt}
\begin{pitfall}
这个论证需要“对顶”的两半含义。单说 $g$ 把顶点送到顶点还不够：原则上一个运动可以把一对对顶点送到由一条棱相连的一对顶点。排除这种可能的正是中心，它被钉在原处，而且必须始终是中点。
\end{pitfall}
\begin{bigpic}
\textbf{原书为什么要讲这两条事实。} 二者合起来是说：正方体的旋转群\emph{就是}四个东西的重排所成的群，而这把一个难对付的对象换成了一个容易对付的对象。在此之前你面对的是 $24$ 个实际的运动，要把其中两个合起来，唯一的办法是在脑子里转动正方体。在此之后，每个运动都是四个字母的一次重排，而把重排合起来是纸笔上的机械操作，不会出错。原书紧接着的下一句就兑现了这一点：“先做一个对称再做另一个”已经变成了“复合两个函数”。\par\vspace{2pt}
那两条要点各司其职，缺一不可。第一条说这套翻译\emph{存在}：每个转动都产生一个重排，所以没有东西落在词典之外。第二条说它\emph{不丢失、也不遗漏}：不同的转动给出不同的重排，所以可以反查回去；而且每个重排都被用到，所以词典里没有空条目。\par\vspace{2pt}
三项好处随之而来。计数 $4!=24$ 用一条完全不同的路径印证了原书第 3 页的计数。问题变得可数：有多少个旋转的阶是 3？数一数 $S_4$ 中的三轮换，共 $8$ 个，正好是绕长对角线的那八个三分之一转。而且这是全书第一个\emph{同构}；定义要到第 13 页才出现，而这个例子让那个定义显得必要，而不只是形式。
\end{bigpic}

\end{minipage}\hfill
\begin{minipage}[t]{360pt}\vspace{0pt}
{\sffamily\bfseries\color{big} $\Phi$ 与复合相容}\par\vspace{2pt}
还有一点观察，下一页会用到两次。先做 $h$ 再做 $g$，对角线先被 $\Phi(h)$ 重排、再被 $\Phi(g)$ 重排，所以
\[\Phi(gh)=\Phi(g)\,\Phi(h).\]
用第 13 页的说法，$\Phi$ 是一个\emph{同态}。下面把这句话画成图：四个固定的位置以对角线命名，每条对角线有一枚棋子，一开始各在自己的位置上。\par\nobreak\vspace{2pt}
\centerline{\begin{tikzpicture}[scale=0.62]
  \node[font=\scriptsize,gray] at (2.30,0.95) {位置 $d_1$};
  \node[font=\scriptsize,gray] at (4.60,0.95) {位置 $d_2$};
  \node[font=\scriptsize,gray] at (6.90,0.95) {位置 $d_3$};
  \node[font=\scriptsize,gray] at (9.20,0.95) {位置 $d_4$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (2.30,0.00) {$d_1$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (4.60,0.00) {$d_2$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (6.90,0.00) {$d_3$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=orange!90!black!30,draw=orange!90!black,thick,text=black] at (9.20,0.00) {$d_4$};
  \node[font=\scriptsize,anchor=west,align=left,text width=190pt] at (10.40,0.00) {开始：对角线 $d_k$ 位于位置 $d_k$};
  \draw[thick,red!80!black] (2.30,-0.45) .. controls (2.30,-1.05) and (4.60,-1.25) .. (4.60,-1.80);
  \draw[thick,blue!70!black] (4.60,-0.45) .. controls (4.60,-1.05) and (9.20,-1.25) .. (9.20,-1.80);
  \draw[thick,green!60!black] (6.90,-0.45) .. controls (6.90,-1.05) and (2.30,-1.25) .. (2.30,-1.80);
  \draw[thick,orange!90!black] (9.20,-0.45) .. controls (9.20,-1.05) and (6.90,-1.25) .. (6.90,-1.80);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (2.30,-2.25) {$d_3$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (4.60,-2.25) {$d_1$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=orange!90!black!30,draw=orange!90!black,thick,text=black] at (6.90,-2.25) {$d_4$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (9.20,-2.25) {$d_2$};
  \node[font=\scriptsize,anchor=west,align=left,text width=190pt] at (10.40,-2.25) {做 $h$ 之后：$\Phi(h)=(d_1\,d_2\,d_4\,d_3)$，一个四轮换};
  \draw[thick,green!60!black] (2.30,-2.70) .. controls (2.30,-3.30) and (4.60,-3.50) .. (4.60,-4.05);
  \draw[thick,red!80!black] (4.60,-2.70) .. controls (4.60,-3.30) and (2.30,-3.50) .. (2.30,-4.05);
  \draw[thick,orange!90!black] (6.90,-2.70) .. controls (6.90,-3.30) and (6.90,-3.50) .. (6.90,-4.05);
  \draw[thick,blue!70!black] (9.20,-2.70) .. controls (9.20,-3.30) and (9.20,-3.50) .. (9.20,-4.05);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (2.30,-4.50) {$d_1$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (4.60,-4.50) {$d_3$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=orange!90!black!30,draw=orange!90!black,thick,text=black] at (6.90,-4.50) {$d_4$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (9.20,-4.50) {$d_2$};
  \node[font=\scriptsize,anchor=west,align=left,text width=190pt] at (10.40,-4.50) {再做 $g$，即绕棱轴 $AB$--$HG$ 的半转：$\Phi(g)=(d_1\,d_2)$};
  \draw[dashed,gray!60] (1.15,-5.58)--(10.58,-5.58);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (2.30,-6.75) {$d_1$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (4.60,-6.75) {$d_2$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (6.90,-6.75) {$d_3$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=orange!90!black!30,draw=orange!90!black,thick,text=black] at (9.20,-6.75) {$d_4$};
  \node[font=\scriptsize,anchor=west,align=left,text width=190pt] at (10.40,-6.75) {\textbf{现在重新开始}};
  \draw[thick,red!80!black] (2.30,-7.20) .. controls (2.30,-7.80) and (2.30,-8.00) .. (2.30,-8.55);
  \draw[thick,blue!70!black] (4.60,-7.20) .. controls (4.60,-7.80) and (9.20,-8.00) .. (9.20,-8.55);
  \draw[thick,green!60!black] (6.90,-7.20) .. controls (6.90,-7.80) and (4.60,-8.00) .. (4.60,-8.55);
  \draw[thick,orange!90!black] (9.20,-7.20) .. controls (9.20,-7.80) and (6.90,-8.00) .. (6.90,-8.55);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (2.30,-9.00) {$d_1$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (4.60,-9.00) {$d_3$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=orange!90!black!30,draw=orange!90!black,thick,text=black] at (6.90,-9.00) {$d_4$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=17pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (9.20,-9.00) {$d_2$};
  \node[font=\scriptsize,anchor=west,align=left,text width=190pt] at (10.40,-9.00) {改为直接做\emph{单个}旋转 $gh$，即绕 $d_1$ 转三分之一圈：底行完全相同，所以 $\Phi(gh)=\Phi(g)\Phi(h)$};
\end{tikzpicture}
}\par\vspace{2pt}
\begin{why}
为什么值得把它单独说出来。正是它让一个难问题拆成若干容易的问题。下一页要证明对角线的\emph{每一个}重排都会出现，只需造出那些交换两条对角线的重排就够了，因为任何重排都是若干这种交换的乘积，而 $\Phi$ 把乘积送到乘积。也正是它把“不同的对称给出不同的重排”化成一句话：只有恒等才被送到恒等。
\end{why}
\begin{tryit}
取 $h$ 为绕竖直轴的四分之一转，$g$ 为绕过 $AB$ 与 $HG$ 中点那条棱轴的半转，就像图里那样。沿着顶点逐个追踪，验证 $gh$ 确实是绕对角线 $AG$ 的三分之一转，因而固定 $d_1$ 并把另外三条循环移动，正如底行所示。
\end{tryit}
\begin{why}
\emph{为什么偏偏是对角线。} 这些对称同样置换顶点、棱和面，但那样得到的是到 $8$ 个、$12$ 个、$6$ 个东西的重排中的映射，而只有 $24$ 个元素的群远远填不满其中任何一个。四条长对角线是这些对称所置换的、不丢失信息的最小的自然集合，而 $24$ 恰好落在 $4!$ 上。挑对作用的对象是真正的技巧所在，第二讲把它变成一般方法。
\end{why}
\end{minipage}
\end{minipage}
}

% ================================================================ INTERLUDE A7 (page 4: the bijection)
\interlude{A7. 原书第 4 页，第二条事实：每个重排都恰好来自一个对称}{
\begin{minipage}[t]{744pt}\vspace{0pt}
\small
第二条事实有两半，需要分别论证：没有哪个重排来自两个不同的对称；每个重排至少来自一个对称。记号沿用上一页。\par\vspace{4pt}
\begin{minipage}[t]{372pt}\vspace{0pt}
{\sffamily\bfseries\color{big} 至多一个：不同的对称给出不同的重排}\par\vspace{2pt}
设 $\Phi(g)$ 是恒等，即每条对角线都被送到自身。看 $d_1=AG$：这时 $g(A)$ 只能是 $A$ 或 $G$。\par\nobreak\vspace{2pt}
\centerline{\centerline{\begin{tikzpicture}[scale=0.62]
  \draw[thick] (0.00,0.00)--(3.00,0.00);
  \draw[thick] (3.00,0.00)--(3.00,3.00);
  \draw[thick] (3.00,3.00)--(0.00,3.00);
  \draw[thick] (0.00,3.00)--(0.00,0.00);
  \draw[thick] (3.00,0.00)--(4.30,1.30);
  \draw[thick] (4.30,1.30)--(4.30,4.30);
  \draw[thick] (4.30,4.30)--(3.00,3.00);
  \draw[thick] (0.00,3.00)--(1.30,4.30);
  \draw[thick] (1.30,4.30)--(4.30,4.30);
  \draw[thick,dashed,gray] (0.00,0.00)--(1.30,1.30);
  \draw[thick,dashed,gray] (1.30,1.30)--(4.30,1.30);
  \draw[thick,dashed,gray] (1.30,1.30)--(1.30,4.30);
  \draw[very thick,red!80!black] (0.00,0.00)--(4.30,4.30);
  \draw[very thick,blue!70!black] (3.00,0.00)--(1.30,4.30);
  \draw[very thick,green!60!black] (3.00,3.00)--(1.30,1.30);
  \draw[very thick,orange!90!black] (0.00,3.00)--(4.30,1.30);
  \node[font=\tiny,red!80!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (0.99,1.59) {$d_1$};
  \node[font=\tiny,blue!70!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (2.88,1.44) {$d_2$};
  \node[font=\tiny,green!60!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (2.75,2.16) {$d_3$};
  \node[font=\tiny,orange!90!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (1.22,2.07) {$d_4$};
  \draw[mkc,line width=1.3pt] (0.00,0.00) circle (9pt);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (0.00,0.00) {$A$};
  \draw[mkc,line width=1.3pt] (3.00,0.00) circle (9pt);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (3.00,0.00) {$B$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (3.00,3.00) {$C$};
  \draw[mkc,line width=1.3pt] (0.00,3.00) circle (9pt);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (0.00,3.00) {$D$};
  \draw[mkc,line width=1.3pt] (1.30,1.30) circle (9pt);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (1.30,1.30) {$E$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (4.30,1.30) {$F$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (4.30,4.30) {$G$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (1.30,4.30) {$H$};
  \node[font=\scriptsize,align=center,anchor=north,text width=150pt] at (2.15,-0.75) {\textbf{情形 1}：若 $g$ 固定 $A$，则每个圈出的邻点都必须原地不动，而不共面的四个点足以把整个运动钉死};
  \draw[thick] (8.20,0.00)--(11.20,0.00);
  \draw[thick] (11.20,0.00)--(11.20,3.00);
  \draw[thick] (11.20,3.00)--(8.20,3.00);
  \draw[thick] (8.20,3.00)--(8.20,0.00);
  \draw[thick] (11.20,0.00)--(12.50,1.30);
  \draw[thick] (12.50,1.30)--(12.50,4.30);
  \draw[thick] (12.50,4.30)--(11.20,3.00);
  \draw[thick] (8.20,3.00)--(9.50,4.30);
  \draw[thick] (9.50,4.30)--(12.50,4.30);
  \draw[thick,dashed,gray] (8.20,0.00)--(9.50,1.30);
  \draw[thick,dashed,gray] (9.50,1.30)--(12.50,1.30);
  \draw[thick,dashed,gray] (9.50,1.30)--(9.50,4.30);
  \draw[very thick,red!80!black] (8.20,0.00)--(12.50,4.30);
  \draw[very thick,blue!70!black] (11.20,0.00)--(9.50,4.30);
  \draw[very thick,green!60!black] (11.20,3.00)--(9.50,1.30);
  \draw[very thick,orange!90!black] (8.20,3.00)--(12.50,1.30);
  \node[font=\tiny,red!80!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (9.19,1.59) {$d_1$};
  \node[font=\tiny,blue!70!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (11.08,1.44) {$d_2$};
  \node[font=\tiny,green!60!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (10.95,2.16) {$d_3$};
  \node[font=\tiny,orange!90!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (9.42,2.07) {$d_4$};
  \draw[mkc,line width=1.3pt] (8.20,0.00) circle (9pt);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (8.20,0.00) {$G$};
  \node[font=\tiny,gray,below left,inner sep=3.5pt] at (8.20,0.00) {A};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (11.20,0.00) {$H$};
  \node[font=\tiny,gray,below right,inner sep=3.5pt] at (11.20,0.00) {B};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (11.20,3.00) {$E$};
  \node[font=\tiny,gray,right,inner sep=3.5pt] at (11.20,3.00) {C};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (8.20,3.00) {$F$};
  \node[font=\tiny,gray,left,inner sep=3.5pt] at (8.20,3.00) {D};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (9.50,1.30) {$C$};
  \node[font=\tiny,gray,left,inner sep=3.5pt] at (9.50,1.30) {E};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (12.50,1.30) {$D$};
  \node[font=\tiny,gray,right,inner sep=3.5pt] at (12.50,1.30) {F};
  \draw[mkc,line width=1.3pt] (12.50,4.30) circle (9pt);
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (12.50,4.30) {$A$};
  \node[font=\tiny,gray,above right,inner sep=3.5pt] at (12.50,4.30) {G};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (9.50,4.30) {$B$};
  \node[font=\tiny,gray,above left,inner sep=3.5pt] at (9.50,4.30) {H};
  \node[font=\scriptsize,align=center,anchor=north,text width=170pt] at (10.35,-0.75) {\textbf{情形 2}：若 $g$ 把 $A$ 送到 $G$，则每个顶点都走向它的对顶点。那是关于中心的反射，而它不是旋转};
\end{tikzpicture}
}}\par\vspace{2pt}
\emph{若 $g(A)=A$。} 与 $A$ 有棱相连的顶点是 $B$、$D$、$E$。对称把棱送到棱，所以 $g(B)$ 是 $B,D,E$ 之一。但 $g$ 又把 $d_2=BH$ 送到自身，所以 $g(B)$ 只能是 $B$ 或 $H$，而 $H$ 不在 $B,D,E$ 之中。于是 $g(B)=B$，同理 $g(D)=D$、$g(E)=E$。空间中的刚体运动若固定不共面的四个点，就固定每一个点，而 $A,B,D,E$ 正是这样四个点。所以 $g$ 是恒等。\par\vspace{2pt}
\emph{若 $g(A)=G$。} 同样的推理迫使 $B\to H$、$D\to F$、$E\to C$：$A$ 的每个邻点都必须落到 $G$ 的某个邻点上，同时又要留在自己那条对角线上。于是每个顶点都走向它的对顶点，这正是关于中心的反射。它确实把正方体映到自身，但它反转定向，与镜像无异，而原书第 3 页已排除这类运动。所以这种情形在那 $24$ 个里根本不会出现。\par\vspace{2pt}
因此满足 $\Phi(g)=1$ 的旋转只有 $g=1$。若两个旋转给出同一个重排，即 $\Phi(g)=\Phi(h)$，则由同态性质有 $\Phi(h^{-1}g)=1$，于是 $h^{-1}g=1$，即 $g=h$。这正是原书第二条要点中“唯一”二字的含义。
\end{minipage}\hfill
\begin{minipage}[t]{356pt}\vspace{0pt}
{\sffamily\bfseries\color{big} 至少一个：每个重排都会出现}\par\vspace{2pt}
只要造出那六个\emph{对换}就够了，即交换两条对角线而让另外两条不动的那些重排。四个东西的任何重排都是若干对换的乘积：先把该到第一位的标号挪过去，再挪第二位，依此类推；而 $\Phi$ 把乘积送到乘积。\par\vspace{2pt}
于是任取两条对角线，比如 $d_1=AG$ 与 $d_2=BH$。它们的四个端点中含有一对\emph{对棱}，这里是 $AB$ 与 $HG$；绕过这两条棱中点的那条轴作半转，就能完成任务。\par\nobreak\vspace{2pt}
\centerline{\centerline{\begin{tikzpicture}[scale=0.62]
  \draw[thick] (0.00,0.00)--(3.00,0.00);
  \draw[thick] (3.00,0.00)--(3.00,3.00);
  \draw[thick] (3.00,3.00)--(0.00,3.00);
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (4.30,4.30) {$G$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (1.30,4.30) {$H$};
  \node[font=\scriptsize,align=center,anchor=north,text width=150pt] at (2.15,-0.75) {\textbf{之前}：四条对角线各有自己的颜色};
  \draw[-{Stealth[length=6pt]},very thick,mkc] (5.6,2.2)--node[above,font=\scriptsize,mkc,align=center]{绕过 $AB$ 与 $HG$\\中点的那条轴\\转半圈}(9.4,2.2);
  \draw[thick] (10.60,0.00)--(13.60,0.00);
  \draw[thick] (13.60,0.00)--(13.60,3.00);
  \draw[thick] (13.60,3.00)--(10.60,3.00);
  \draw[thick] (10.60,3.00)--(10.60,0.00);
  \draw[thick] (13.60,0.00)--(14.90,1.30);
  \draw[thick] (14.90,1.30)--(14.90,4.30);
  \draw[thick] (14.90,4.30)--(13.60,3.00);
  \draw[thick] (10.60,3.00)--(11.90,4.30);
  \draw[thick] (11.90,4.30)--(14.90,4.30);
  \draw[thick,dashed,gray] (10.60,0.00)--(11.90,1.30);
  \draw[thick,dashed,gray] (11.90,1.30)--(14.90,1.30);
  \draw[thick,dashed,gray] (11.90,1.30)--(11.90,4.30);
  \draw[very thick,red!80!black] (10.60,0.00)--(14.90,4.30);
  \draw[very thick,blue!70!black] (13.60,0.00)--(11.90,4.30);
  \draw[very thick,green!60!black] (13.60,3.00)--(11.90,1.30);
  \draw[very thick,orange!90!black] (10.60,3.00)--(14.90,1.30);
  \node[font=\tiny,red!80!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (11.59,1.59) {$d_1$};
  \node[font=\tiny,blue!70!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (13.48,1.44) {$d_2$};
  \node[font=\tiny,green!60!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (13.35,2.16) {$d_3$};
  \node[font=\tiny,orange!90!black,fill=white,fill opacity=0.85,text opacity=1,inner sep=0.8pt] at (11.82,2.07) {$d_4$};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (10.60,0.00) {$B$};
  \node[font=\tiny,gray,below left,inner sep=3.5pt] at (10.60,0.00) {A};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (13.60,0.00) {$A$};
  \node[font=\tiny,gray,below right,inner sep=3.5pt] at (13.60,0.00) {B};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (13.60,3.00) {$E$};
  \node[font=\tiny,gray,right,inner sep=3.5pt] at (13.60,3.00) {C};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (10.60,3.00) {$F$};
  \node[font=\tiny,gray,left,inner sep=3.5pt] at (10.60,3.00) {D};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (11.90,1.30) {$C$};
  \node[font=\tiny,gray,left,inner sep=3.5pt] at (11.90,1.30) {E};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (14.90,1.30) {$D$};
  \node[font=\tiny,gray,right,inner sep=3.5pt] at (14.90,1.30) {F};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (14.90,4.30) {$H$};
  \node[font=\tiny,gray,above right,inner sep=3.5pt] at (14.90,4.30) {G};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=13pt,fill=gray!12,draw=gray!60!black,thick,text=black] at (11.90,4.30) {$G$};
  \node[font=\tiny,gray,above left,inner sep=3.5pt] at (11.90,4.30) {H};
  \node[font=\scriptsize,align=center,anchor=north,text width=170pt] at (12.75,-0.75) {\textbf{之后}：$A\leftrightarrow B$ 且 $G\leftrightarrow H$，所以 $d_1\leftrightarrow d_2$；同时 $C\leftrightarrow E$ 且 $D\leftrightarrow F$，所以 $d_3$ 与 $d_4$ 各自回到自身};
\end{tikzpicture}
}}\par\vspace{2pt}
四条对角线中任取两条，它们的端点都以同样的方式被一对对棱连接，而对角线有六对、对棱也有六对。于是这六个棱轴半转恰好给出那六个对换。
\begin{bigpic}
把这两页合起来看：$\Phi$ 是从正方体的旋转到四个东西的重排的一个一一的同态，而它的像包含每个对换，因而包含全部。所以 $\Phi$ 是一个\emph{同构}：正方体的旋转群\emph{就是} $S_4$，特别地它有 $4!=24$ 个元素。这是用另一条独立的路径重新得到原书第 3 页的那个计数。
\end{bigpic}
\begin{pitfall}
这两半是真正分开的。一旦知道两边各有 $24$ 个元素，任何一半都能推出另一半，原书关于计数的那句话用的正是这个捷径。但那个计数来自第 3 页“顶点加自转”的论证，所以用它来证明两半就成了循环论证。还要注意：若允许镜像，第一半会直接失效——关于中心的反射固定全部四条对角线却不是恒等，于是 $48$ 个对称会二对一地盖住那 $24$ 个重排。
\end{pitfall}
\begin{tryit}
算一算绕过 $AD$ 与 $FG$ 中点那条轴的半转给出哪一个对换。然后解释：为什么绕长对角线的三分之一转一定给出三轮换？哪条对角线不动，另外三条为什么必须循环移动？把你的答案与补充页 B2 的对照表比较。
\end{tryit}
\end{minipage}
\end{minipage}
}
...
\centerline{\begin{tikzpicture}[scale=0.45]
  ...
  \node[font=\tiny,align=center,anchor=north] at (1.044,-0.350) {开始};
  ...
  \node[font=\tiny,align=center,anchor=north] at (5.644,-0.350) {做 $r$ 之后（绕竖直轴\\转四分之一圈）};
  ...
  \node[font=\tiny,align=center,anchor=north] at (10.244,-0.350) {再做 $1$，即什么也不做：\\毫无变化，$1r=r$};
...
\centerline{\begin{tikzpicture}[scale=0.45]
  ...
  \node[font=\tiny\bfseries,circle,inner sep=0.3pt,minimum size=8pt,fill=brown!80!black!30,draw=brown!80!black,thick,text=black] at (5.223,2.073) {G};
  \node[font=\tiny\bfseries,circle,inner sep=0.3pt,minimum size=8pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (4.600,1.450) {H};
  \node[font=\tiny,align=center,anchor=north] at (5.644,-0.350) {做 $r$ 之后};
  \draw[thick] (9.200,0.000)--(10.650,0.000);
  \draw[thick] (10.650,0.000)--(10.650,1.450);
  \draw[thick] (10.650,1.450)--(9.200,1.450);
  \draw[thick] (9.200,1.450)--(9.200,0.000);
  ...
  \node[font=\tiny,align=center,anchor=north] at (10.244,-0.350) {再做 $r^{-1}$，即反向\\转四分之一圈：每个顶点都归位};
\end{tikzpicture}}\par\vspace{2pt}
...
\centerline{\begin{tikzpicture}[scale=0.45]
  ...
  \node[font=\tiny,align=center,anchor=north] at (4.544,-0.350) {做 $h$ 之后};
  ...
  \node[font=\tiny,align=center,anchor=north] at (8.044,-0.350) {再做 $g$};
  ...
  \node[font=\tiny,align=center,anchor=north] at (11.544,-0.350) {再做 $f$};
\end{tikzpicture}}\par\vspace{2pt}
...
\begin{tikzpicture}[font=\scriptsize,>={Stealth[length=3pt]}]
  \node[draw=big,thick,rounded corners=2pt,fill=big!6,align=center,text width=92pt,inner sep=3pt] (set) at (0,0) {\textbf{一个集合 $G$}\\ 例如 24 个旋转，或 $\Z$};
  \node[draw=big,thick,rounded corners=2pt,fill=big!6,align=center,text width=150pt,inner sep=3pt] (mul) at (4.9,0) {\textbf{集合上的一条规则} $(g,h)\mapsto gh$\\ 例如“先 $h$ 后 $g$”，或 $m+n$\\ 答案必须留在 $G$ 内（封闭性）};
  \node[font=\scriptsize\itshape,gray,anchor=west] at (-0.85,-1.15) {这条规则必须遵守三条约定：};
  \node[draw=why,thick,rounded corners=2pt,fill=why!6,align=center,text width=90pt,inner sep=3pt] (id) at (0.3,-2.1) {\textbf{单位元}\\ 存在 $1$ 使 $1g=g1=g$\\ （什么也不做；$0$）};
  \node[draw=why,thick,rounded corners=2pt,fill=why!6,align=center,text width=96pt,inner sep=3pt] (inv) at (4.2,-2.1) {\textbf{逆元}\\ 每个 $g$ 都有 $h$ 使 $gh=hg=1$\\ （撤销；$-n$）};
  \node[draw=why,thick,rounded corners=2pt,fill=why!6,align=center,text width=90pt,inner sep=3pt] (as) at (8.1,-2.1) {\textbf{结合律}\\ $(fg)h=f(gh)$\\ （括号无关紧要）};
...
\begin{tikzpicture}[scale=0.68]
  ...
  \node[font=\scriptsize,align=center,anchor=north] at (1.044,-0.450) {开始};
  ...
  \node[font=\scriptsize,align=center,anchor=north] at (5.394,-0.450) {做 $h$ 之后：绕竖直轴\\转四分之一圈};
  ...
  \node[font=\scriptsize,align=center,anchor=north] at (9.744,-0.450) {再做 $g$：绕左右轴转四分之一圈。\\净效果：绕 $CE$ 转 $120^\circ$，\\并不是四分之一转};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.68]
  ...
  \node[font=\scriptsize,align=center,anchor=north] at (4.944,-0.450) {做 $r$ 之后：绕竖直轴\\转四分之一圈};
  ...
  \node[font=\scriptsize,align=center,anchor=north] at (8.844,-0.450) {再做 $1$（什么也不做）：\\完全相同，所以 $1r=r$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.68]
  ...
  \node[font=\tiny\bfseries,circle,inner sep=0.5pt,minimum size=9pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (3.900,1.450) {H};
  \node[font=\tiny,gray,left,inner sep=1.5pt] at (3.900,1.450) {D};
  \node[font=\scriptsize,align=center,anchor=north] at (4.944,-0.450) {做 $r$ 之后};
  \draw[thick] (7.800,0.000)--(9.250,0.000);
  \draw[thick] (9.250,0.000)--(9.250,1.450);
  \draw[thick] (9.250,1.450)--(7.800,1.450);
  \draw[thick] (7.800,1.450)--(7.800,0.000);
  ...
  \node[font=\tiny,gray,above left,inner sep=1.5pt] at (8.424,2.073) {H};
  \node[font=\scriptsize,align=center,anchor=north] at (8.844,-0.450) {再做 $r^{-1}$，即反方向的\\四分之一转：每个顶点都归位};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.68]
  ...
  \node[font=\tiny\bfseries,circle,inner sep=0.5pt,minimum size=9pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (3.900,1.450) {H};
  \node[font=\tiny,gray,left,inner sep=1.5pt] at (3.900,1.450) {D};
  \node[font=\scriptsize,align=center,anchor=north] at (4.944,-0.450) {做 $h$ 之后：绕竖直轴\\转四分之一圈};
  \draw[thick] (7.800,0.000)--(9.250,0.000);
  \draw[thick] (9.250,0.000)--(9.250,1.450);
  \draw[thick] (9.250,1.450)--(7.800,1.450);
  \draw[thick] (7.800,1.450)--(7.800,0.000);
  ...
  \node[font=\tiny,gray,below left,inner sep=1.5pt] at (7.800,0.000) {A};
  \node[font=\scriptsize,align=center,anchor=north] at (8.844,-0.450) {再做 $g$：绕左右轴\\转四分之一圈};
  ...
  \node[font=\scriptsize,align=center,anchor=north] at (12.744,-0.450) {再做 $f$：绕竖直轴\\转半圈};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.68]
  ...
  \node[font=\tiny\bfseries,circle,inner sep=0.5pt,minimum size=9pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (3.900,1.450) {H};
  \node[font=\tiny,gray,left,inner sep=1.5pt] at (3.900,1.450) {D};
  \node[font=\scriptsize,align=center,anchor=north] at (4.944,-0.450) {做 $h$ 之后};
  \draw[thick] (7.800,0.000)--(9.250,0.000);
  \draw[thick] (9.250,0.000)--(9.250,1.450);
  \draw[thick] (9.250,1.450)--(7.800,1.450);
  \draw[thick] (7.800,1.450)--(7.800,0.000);
  ...
  \node[font=\tiny,gray,right,inner sep=1.5pt] at (9.873,0.623) {F};
  \node[font=\scriptsize,align=center,anchor=north] at (8.844,-0.450) {再做单个动作 $fg$：\\绕棱轴 $AB$--$HG$ 转半圈};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.68]
  ...
  \node[font=\tiny,gray,below left,inner sep=1.5pt] at (3.900,0.000) {A};
  \node[font=\scriptsize,align=center,anchor=north] at (4.944,-0.450) {做单个动作 $gh$ 之后：\\绕对角线 $CE$ 转 $120^\circ$};
  \draw[thick] (7.800,0.000)--(9.250,0.000);
  \draw[thick] (9.250,0.000)--(9.250,1.450);
  \draw[thick] (9.250,1.450)--(7.800,1.450);
  \draw[thick] (7.800,1.450)--(7.800,0.000);
  ...
  \node[font=\tiny\bfseries,circle,inner sep=0.5pt,minimum size=9pt,fill=magenta!75!black!30,draw=magenta!75!black,thick,text=black] at (9.873,0.623) {H};
  \node[font=\tiny,gray,right,inner sep=1.5pt] at (9.873,0.623) {F};
  \node[font=\scriptsize,align=center,anchor=north] at (8.844,-0.450) {再做 $f$};
\end{tikzpicture}
...
\centerline{\begin{tikzpicture}[scale=1.0,>={Stealth[length=5pt]},font=\scriptsize]
  \node[draw=big,thick,rounded corners=2pt,fill=big!7,align=center,text width=74pt,inner sep=3pt] (N0) at (0,0) {\textbf{一个几何\\对象}\\[1pt]正方体、多边形、\\加了装饰的直线};
  \node[draw=big,thick,rounded corners=2pt,fill=big!7,align=center,text width=74pt,inner sep=3pt] (N1) at (4.5,0) {\textbf{它的对称\\所成的群}\\[1pt]一个集合配一条规则，\\并满足三条公理};
  \node[draw=big,thick,rounded corners=2pt,fill=big!7,align=center,text width=74pt,inner sep=3pt] (N2) at (9.0,0) {\textbf{少数几个\\生成元}\\[1pt]每个元素都是\\几个字母组成的字};
  \node[draw=big,thick,rounded corners=2pt,fill=big!7,align=center,text width=74pt,inner sep=3pt] (N3) at (13.5,0) {\textbf{一个表现}\\[1pt]用一行记号\\写下整个群};
  \node[draw=mkc,thick,rounded corners=2pt,fill=mkc!7,align=center,text width=74pt,inner sep=3pt] (N4) at (18.0,0) {\textbf{一张凯莱图}\\[1pt]每个元素一个点，\\每个生成元一种箭头};
  \draw[->,very thick,mkc] (N0)--node[above,font=\tiny,mkc,align=center]{取它的\\对称}(N1);
  \draw[->,very thick,mkc] (N1)--node[above,font=\tiny,mkc,align=center]{选一个\\生成集}(N2);
  \draw[->,very thick,mkc] (N2)--node[above,font=\tiny,mkc,align=center]{加上\\关系}(N3);
  \draw[->,very thick,mkc] (N3)--node[above,font=\tiny,mkc,align=center]{画出来}(N4);
  \node[font=\scriptsize,align=center,anchor=north,text width=470pt] at (9.0,-1.15) {第一讲从左走到右。第二讲把这个圈闭合：它证明右边那张图的对称恰好就是中间那个群。};
\end{tikzpicture}
}\par\vspace{5pt}
...
\node[box,text width=86pt] (obj) at (0,3.3) {\textbf{一个几何对象}\\ 正方体、$n$ 边形、标了刻度的直线、上了色的格点、树};
\node[box,text width=86pt] (sym) at (5.0,3.3) {\textbf{它的对称}\\ 使它看上去不变的那些动作};
\node[hub,text width=104pt] (grp) at (10.2,3.3) {\textbf{\large 一个群}\\ 一个集合，集合上的一条规则，\\ 以及三条约定：\\ 单位元、逆元、结合律};
\node[ex,text width=84pt] (exs) at (15.6,3.3) {\textbf{出场的群}\\ $D_n$、$S_n$、$\Z/n\Z$、$\Z$、$\Z^2$、$\GL(n,\R)$、$F_2$};
\draw[->,very thick,mkc] (obj)--node[lab,above]{收集全部\\刚体运动}(sym);
\draw[->,very thick,mkc] (sym)--node[lab,above]{验证\\三条公理}(grp);
\draw[<->,thick,gray!70!black] (grp)--node[lab,above,text=gray!60!black]{实例}(exs);

% ---------- left cluster: describing a group ----------
\node[font=\scriptsize\bfseries,color=big] at (3.4,1.35) {描述一个群};
\node[box,text width=66pt] (gen) at (0.4,0.2) {\textbf{生成集} $S$\\ 少数几个元素};
\node[box,text width=66pt] (wrd) at (3.9,0.2) {$S$ 中的\textbf{字}\\ 每个元素都是一个字};
\node[box,text width=66pt] (rel) at (7.4,0.2) {\textbf{关系}\\ 哪些字彼此相等};
\node[box,text width=72pt] (pre) at (11.0,0.2) {\textbf{表现}\\ $\langle S \mid R\rangle$};
\draw[->,thick,mkc] (gen)--(wrd);
\draw[->,thick,mkc] (wrd)--(rel);
\draw[->,thick,mkc] (rel)--(pre);
\draw[->,thick,mkc] (grp) to[out=200,in=90] node[lab,above left,pos=0.72]{选取少数\\几个元素}(gen);

% ---------- right cluster: comparing groups ----------
\node[font=\scriptsize\bfseries,color=big] at (15.6,1.35) {比较两个群};
\node[box,text width=74pt] (hom) at (14.3,0.2) {\textbf{同态}\\ $f(gh)=f(g)f(h)$};
\node[box,text width=66pt] (iso) at (18.0,0.2) {\textbf{同构}\\ 同一个群，\\ 换个名字};
\node[box,text width=74pt] (ker) at (14.3,-2.1) {\textbf{核}\\ 一个正规子群};
\node[box,text width=66pt] (quo) at (18.0,-2.1) {\textbf{商群} $G/N$\\ 例如 $\Z/n\Z$};
\draw[->,thick,mkc] (hom)--node[lab,above]{是双射}(iso);
\draw[->,thick,mkc] (hom)--node[lab,left]{它消灭了什么}(ker);
\draw[->,thick,mkc] (ker)--node[lab,above]{商掉}(quo);
\draw[->,very thick,mkc] (grp) to[out=340,in=90] node[lab,right,pos=0.6]{群之间的\\映射}(hom);

% ---------- bottom: the road out ----------
\node[hub,text width=118pt] (cay) at (6.6,-3.4) {\textbf{\large 凯莱图} $\Gamma(G,S)$\\ 每个元素一个点，\\ 每个生成元一种彩色箭头};
\draw[->,very thick,mkc] (pre) to[out=250,in=20] node[lab,right,pos=0.45]{画出来}(cay);
\draw[->,very thick,dashed,why,rounded corners=7pt] (cay.west) -- (-2.6,-3.4) -- (-2.6,3.3) -- (obj.west);
\node[lab,text=why,align=center,anchor=east] at (-2.75,0.1) {第二讲：\\那张图的\\对称又正好\\是 $G$};

% ---------- notes ----------
\node[ex,text width=158pt,anchor=north west] at (12.4,-3.2) {\textbf{值得注意。} 字变成图中的路径，关系变成闭合的圈，而一个元素的字长变成它到单位元的距离。要画这张图，只需要 $G$ 和一个生成集。};
\end{tikzpicture}}\par\vspace{4pt}
\begin{minipage}[t]{368pt}\vspace{0pt}
\begin{why}
...
\centerline{\begin{tikzpicture}[scale=0.6]
  ...
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (0.000,-1.220) {开始};
  ...
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (4.500,-1.220) {做 $t$ 之后};
  ...
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (9.000,-1.220) {再做 $s$：逆时针\\转一格，即 $st$};
  ...
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (13.500,-1.220) {但先 $s$ 后 $t$：\\顺时针转一格，即 $ts$};
\end{tikzpicture}
}\par\vspace{2pt}
...
\centerline{\begin{tikzpicture}[scale=0.6]
  ...
  \node[font=\tiny,gray] at (1.217,0.396) {5};
  \node[font=\tiny\bfseries,circle,inner sep=0.3pt,minimum size=8pt,fill=violet!30,draw=violet,thick,text=black] at (0.951,0.309) {5};
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (0.000,-1.220) {开始：顶点 $k$ 在\\位置 $k$};
  \draw[thick,big] (4.500,1.000)--(3.549,0.309)--(3.912,-0.809)--(5.088,-0.809)--(5.451,0.309)--cycle;
  \draw[dashed,thick,mkc] (4.500,-1.400)--(4.500,1.400);
  \node[font=\tiny,gray] at (4.500,1.280) {1};
  \node[font=\tiny\bfseries,circle,inner sep=0.3pt,minimum size=8pt,fill=red!80!black!30,draw=red!80!black,thick,text=black] at (4.500,1.000) {1};
  ...
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (9.000,-1.220) {再做 $1$：完全相同，\\所以 $1t=t1=t$};
\end{tikzpicture}
}\par\vspace{2pt}
...
\centerline{\begin{tikzpicture}[scale=0.6]
  ...
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (4.500,-1.220) {转一格 $st$ 之后};
  \draw[thick,big] (9.000,1.000)--(8.049,0.309)--(8.412,-0.809)--(9.588,-0.809)--(9.951,0.309)--cycle;
  ...
  \node[font=\tiny,align=center,anchor=north,text width=62pt] at (9.000,-1.220) {再做 $(st)^4$：回到原位，\\所以 $(st)^{-1}=(st)^4$};
\end{tikzpicture}
}\par\vspace{2pt}
...
\centerline{\begin{tikzpicture}[scale=0.5]
  \node[font=\scriptsize,gray] at (1.35,0.6) {位置 1};
  \node[font=\scriptsize,gray] at (2.70,0.6) {位置 2};
  \node[font=\scriptsize,gray] at (4.05,0.6) {位置 3};
  \node[font=\scriptsize,gray] at (5.40,0.6) {位置 4};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (5.90,0.00) {开始：第 $k$ 枚棋子在位置 $k$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (5.90,-2.10) {做 $\sigma=(1\,2\,3)$ 之后};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (5.90,-4.20) {再做 $\tau=(3\,4)$：合起来是 $\tau\sigma=(1\,2\,4\,3)$，仍是一次\\重排，所以这个集合是封闭的};
\end{tikzpicture}
}\par\vspace{3pt}
...
\centerline{\begin{tikzpicture}[scale=0.5]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=green!60!black!30,draw=green!60!black,thick,text=black] at (4.05,0.00) {3};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=11pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (5.40,0.00) {4};
  \node[font=\scriptsize,anchor=west,align=left] at (5.90,0.00) {开始};
  \draw[thick,red!80!black] (1.35,-0.30) .. controls (1.35,-0.90) and (2.70,-1.20) .. (2.70,-1.80);
  \draw[thick,orange!95!black] (2.70,-0.30) .. controls (2.70,-0.90) and (4.05,-1.20) .. (4.05,-1.80);
  \draw[thick,green!60!black] (4.05,-0.30) .. controls (4.05,-0.90) and (1.35,-1.20) .. (1.35,-1.80);
  \draw[thick,blue!70!black] (5.40,-0.30) .. controls (5.40,-0.90) and (5.40,-1.20) .. (5.40,-1.80);
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (5.90,-4.20) {再做 $1=()$：这一行没有变化，所以 $1\sigma=\sigma$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (5.90,-6.30) {改成再做 $\sigma^{-1}=(1\,3\,2)$：每枚棋子都归位，\\所以 $\sigma^{-1}\sigma=1$};
\end{tikzpicture}
}\par\vspace{3pt}
...
$(st)^2$ & rotation & by $144^\circ$ (2 格) & 3 4 5 1 2\\
...
\begin{tikzpicture}[scale=0.45,>={Stealth[length=4pt]}]
  \foreach \dx/\st/\nm in {0/1/(1\,2\,4), 5.2/2/(2\,4\,1), 10.4/4/(4\,1\,2)} {
    \begin{scope}[shift={(\dx,0)}]
      ...
      \node[font=\scriptsize,mkc] at (0,-2.0) {从 \st 出发：$\nm$};
    \end{scope}
  }
...
\begin{tikzpicture}[>={Stealth[length=4pt]},x=1cm,y=0.42cm]
  \node[font=\scriptsize,gray] at (0,1.1) {开始}; \node[font=\scriptsize,gray] at (2.6,1.1) {做 $(1\,2\,4)(3\,5)$ 之后}; \node[font=\scriptsize,gray] at (5.2,1.1) {做 $(2\,6)$ 之后};
  ...
  \node[font=\scriptsize,mkc] at (1.3,-0.3) {第一个因子}; \node[font=\scriptsize,mkc] at (3.9,-0.3) {第二个因子};
\end{tikzpicture}
\end{center}
...
\centering
\begin{tikzpicture}[scale=0.62]
  \node[font=\scriptsize,gray] at (1.5,0.75) {位置 1};
  \node[font=\scriptsize,gray] at (3.0,0.75) {位置 2};
  \node[font=\scriptsize,gray] at (4.5,0.75) {位置 3};
  \node[font=\scriptsize,gray] at (6.0,0.75) {位置 4};
  \node[font=\scriptsize,gray] at (7.5,0.75) {位置 5};
  \node[font=\scriptsize,gray] at (9.0,0.75) {位置 6};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,0.0) {开始：数字 $k$ 在位置 $k$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,-2.6) {做 $(1\,2\,4)(3\,5)$ 之后：位置 1 到位置 2，2 到 4，4 到 1，\\3 到 5，5 到 3；位置 6 不动};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,-5.2) {做 $(2\,6)$ 之后：位置 2 与 6 互换};
\end{tikzpicture}
\par\vspace{6pt}
\raggedright
...
\begin{tikzpicture}[scale=0.62]
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,-1.9) {做 $(3\,4)$ 之后：位置 3 与 4 互换};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,-3.8) {做 $(2\,3)$ 之后：位置 2 与 3 互换};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,-5.699999999999999) {做 $(4\,5)$ 之后：位置 4 与 5 互换};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,-7.6) {做 $(1\,2)$ 之后：位置 1 与 2 互换};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (9.6,-9.5) {做 $(3\,4)$ 之后：位置 3 与 4 互换\\$1$ 在位置 2，$2$ 在 4，$4$ 在 1，$3$ 在 5，$5$ 在 3};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
...
\begin{tikzpicture}[scale=0.8,>={Stealth[length=4pt]}]
  ...
  \node[font=\scriptsize,gray] at (7.800000000000001,1.0) {6 不动};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
\begin{why}
...
\centerline{\begin{tikzpicture}[scale=0.62]
  ...
  \node[font=\tiny,gray,anchor=west] at (9.9,0) {整数轴};
\begin{scope}[shift={(0.6,-3.3)}]
  ...
  \node[font=\tiny,align=center,anchor=north,text width=90pt] at (0.000,-1.200) {每种颜色一个点：五个元素，\\$\Z/5\Z=\{0,1,2,3,4\}$};
\end{scope}
  \draw[-{Stealth[length=4pt]},thick,mkc] (-1.6,-0.7) to[out=-90,in=150] (-0.3,-2.5);
  \node[font=\tiny,mkc,anchor=east] at (-1.8,-1.2) {卷起};
  \node[font=\scriptsize,align=left,anchor=north west,text width=165pt] at (2.6,-1.9) {同色表示被 $5$ 除的余数相同，因而是 $\Z/5\Z$ 的同一个元素：整数 $\dots,-5,0,5,10,\dots$ 都叫作 $0$。这五个名字指的是五种颜色，而不是五个特定的整数。};
\end{tikzpicture}
}\par\vspace{3pt}
...
\centerline{\begin{tikzpicture}[scale=0.7]
  ...
  \node[font=\tiny\bfseries,circle,inner sep=0.3pt,minimum size=9.5pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (-0.951,0.309) {4};
  \node[font=\tiny,align=center,anchor=north,text width=86pt] at (0.000,-1.200) {$1\oplus2$：从 $1$ 往前走两步。\\$1+2=3\le4$：无需绕回，答案是 $3$};
  ...
  \node[font=\tiny,pit,anchor=south] at (4.700,1.300) {越过了 $0$，所以减 $5$};
  \node[font=\tiny,align=center,anchor=north,text width=86pt] at (4.700,-1.200) {$3\oplus4$：从 $3$ 往前走四步。\\$3+4=7\ge5$，所以 $7-5=2$};
  ...
  \node[font=\tiny,align=center,anchor=north,text width=86pt] at (9.400,-1.200) {$2\oplus3=0$：从 $2$ 往前走三步\\正好走完一圈，所以 $-2=3$};
\end{tikzpicture}
}\par\vspace{2pt}
\begin{pitfall}
...
\begin{scope}[shift={(0,0)}]
  ...
  \node[font=\scriptsize,align=center] at (0,-2.0) {指针指向 9};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (1.9,0) -- node[above,font=\scriptsize,mkc,align=center] {加 4：\\顺时针走 4 步} (3.4,0);
\begin{scope}[shift={(5.4,0)}]
  ...
  \node[font=\scriptsize,align=center] at (0,-2.0) {指针指向 1：$9+4=13$，而 $13-12=1$};
\end{scope}
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
...
\begin{scope}[shift={(0,0)}]
  ...
  \node[font=\scriptsize,align=center] at (0,-1.95) {之前};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (2.0,0) -- node[above,font=\scriptsize,mkc,align=center] {转动\\2 格} (3.3,0);
\begin{scope}[shift={(5.3,0)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=12pt,fill=violet!30,draw=violet,thick,text=black] at (-1.236,0.402) {5};
  \node[font=\scriptsize,align=center] at (0,-1.95) {之后：箭头仍然朝同一方向绕行 $\checkmark$};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (7.3,0) -- node[above,font=\scriptsize,mkc,align=center] {关于竖直轴\\作反射} (8.6,0);
\begin{scope}[shift={(10.6,0)}]
  ...
  \node[font=\scriptsize,align=center] at (0,-1.95) {之后：每个箭头都反了向 $\times$};
\end{scope}
\end{tikzpicture}
\par\vspace{6pt}
\raggedright
...
\begin{scope}[shift={(0,0)}]
  ...
  \node[font=\scriptsize,align=center] at (0,-1.95) {开始};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (2.0,0) -- node[above,font=\scriptsize,mkc] {2 格} (3.3,0);
\begin{scope}[shift={(5.3,0)}]
  \draw[thick,big] (0.0,1.3)--(-1.236,0.402)--(-0.764,-1.052)--(0.764,-1.052)--(1.236,0.402)--cycle;
  \draw[-{Stealth[length=4pt]},very thick,red!75!black] (-0.46968,0.9587600000000001)--(-0.76632,0.7432400000000001);
  \draw[-{Stealth[length=4pt]},very thick,red!75!black] (-1.05664,-0.15052)--(-0.94336,-0.49948000000000004);
  ...
  \node[font=\scriptsize,align=center] at (0,-1.95) {转 2 格之后};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (7.3,0) -- node[above,font=\scriptsize,mkc] {再转 4 格} (8.6,0);
\begin{scope}[shift={(10.6,0)}]
  \draw[thick,big] (0.0,1.3)--(-1.236,0.402)--(-0.764,-1.052)--(0.764,-1.052)--(1.236,0.402)--cycle;
  \draw[-{Stealth[length=4pt]},very thick,red!75!black] (-0.46968,0.9587600000000001)--(-0.76632,0.7432400000000001);
  \draw[-{Stealth[length=4pt]},very thick,red!75!black] (-1.05664,-0.15052)--(-0.94336,-0.49948000000000004);
  ...
  \node[font=\scriptsize,align=center] at (0,-1.95) {转 $2+4=6$ 格 $=$ 转 1 格};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (12.6,0) -- node[above,font=\scriptsize,mkc] {比较} (13.9,0);
\begin{scope}[shift={(15.9,0)}]
  ...
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=12pt,fill=blue!70!black!30,draw=blue!70!black,thick,text=black] at (1.236,0.402) {4};
  \node[font=\scriptsize\bfseries,circle,inner sep=1pt,minimum size=12pt,fill=violet!30,draw=violet,thick,text=black] at (0.0,1.3) {5};
  \node[font=\scriptsize,align=center] at (0,-1.95) {从起点转 1 格：结果相同};
\end{scope}
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
...
\begin{scope}[shift={(0,0)}]
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.5,0.05) {开始};
\end{scope}
\begin{scope}[shift={(0,-1.6)}]
  ...
  \draw[-{Stealth[length=2.5pt]},thick,blue!65!black] (2.3,0.32)--(2.7,0.32);
  \draw[-{Stealth[length=2.5pt]},thick,blue!65!black] (3.3,0.32)--(3.7,0.32);
  \node[font=\scriptsize,anchor=west,align=left] at (4.5,0.05) {平移 $3$ 之后：每个点都落在点上，\\每个箭头仍然指向右 $\checkmark$};
\end{scope}
\begin{scope}[shift={(0,-3.2)}]
  ...
  \draw[-{Stealth[length=2.5pt]},thick,blue!65!black] (2.7,0.32)--(2.3,0.32);
  \draw[-{Stealth[length=2.5pt]},thick,blue!65!black] (3.7,0.32)--(3.3,0.32);
  \node[font=\scriptsize,anchor=west,align=left] at (4.5,0.05) {关于点 $2$ 作反射之后：点仍落在点上，\\但每个箭头现在都指向左 $\times$};
\end{scope}
\end{tikzpicture}
\end{center}
\begin{why}
...
\begin{scope}[shift={(0,0)}]
  ...
  \node[font=\scriptsize,align=center,text width=3.6cm] at (2,-0.85) {开始：六个有色点，红色那个在 $(0,0)$};
\end{scope}
...
\begin{scope}[shift={(6.2,0)}]
  ...
  \node[font=\scriptsize,align=center,text width=3.6cm] at (2,-0.85) {平移 $(2,1)$ 之后：右、右、上；红点现在在 $(2,1)$};
\end{scope}
...
\begin{scope}[shift={(12.4,0)}]
  ...
  \node[font=\scriptsize,align=center,text width=3.6cm] at (2,-0.85) {再平移 $(-1,2)$：红点到了 $(1,3)$；合起来是 $(2,1)+(-1,2)=(1,3)$};
\end{scope}
\end{tikzpicture}
\end{center}
...
\begin{scope}[shift={(0,0)}]
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.6,0.1) {开始：标号 $k$ 的点位于 $k$};
\end{scope}
\begin{scope}[shift={(0,-1.7)}]
  ...
  \draw[-{Stealth[length=3pt]},thick,blue!65!black] (2.3,0.35)--(2.7,0.35);
  \draw[-{Stealth[length=3pt]},thick,blue!65!black] (3.3,0.35)--(3.7,0.35);
  \node[font=\scriptsize,anchor=west,align=left] at (4.6,0.1) {平移 $+3$ 之后：每个点都向右移了 3};
\end{scope}
\begin{scope}[shift={(0,-3.4)}]
  ...
  \draw[-{Stealth[length=3pt]},thick,blue!65!black] (2.3,0.35)--(2.7,0.35);
  \draw[-{Stealth[length=3pt]},thick,blue!65!black] (3.3,0.35)--(3.7,0.35);
  \node[font=\scriptsize,anchor=west,align=left] at (4.6,0.1) {再平移 $-2$：净效果是 $+1$，因为 $3+(-2)=1$};
\end{scope}
\begin{scope}[shift={(0,-5.1)}]
  ...
  \draw[-{Stealth[length=3pt]},thick,blue!65!black] (2.7,0.35)--(2.3,0.35);
  \draw[-{Stealth[length=3pt]},thick,blue!65!black] (3.7,0.35)--(3.3,0.35);
  \node[font=\scriptsize,anchor=west,align=left] at (4.6,0.1) {改成关于 0 作反射：点仍落在点上，但箭头翻转了 $\times$};
\end{scope}
\end{tikzpicture}
\par\vspace{6pt}
\begin{minipage}[t]{360pt}\vspace{0pt}\raggedright
...
\begin{scope}[shift={(0,0)}]
  ...
  \fill[red!75!black] (2.0,0.0) circle (2.2pt);
  \fill[red!75!black] (2.0,1.0) circle (2.2pt);
  \node[font=\scriptsize,align=center] at (0,-2.4) {开始};
\end{scope}
...
\begin{scope}[shift={(8.2,0)}]
  ...
  \node[font=\scriptsize,align=center] at (0,-2.4) {平移 $(2,1)$ 之后：每种颜色都落在同色上 $\checkmark$};
\end{scope}
  \draw[-{Stealth[length=5pt]},very thick,mkc] (11.4,0) -- node[above,font=\scriptsize,mkc,align=center] {四分之一\\转} (13.2,0);
\begin{scope}[shift={(16.8,0)}]
  ...
  \fill[red!75!black] (0.0,2.0) circle (2.2pt);
  \fill[red!75!black] (-1.0,2.0) circle (2.2pt);
  \node[font=\scriptsize,align=center] at (0,-2.4) {转四分之一圈：蓝色落到绿色上 $\times$};
\end{scope}
\end{tikzpicture}
\end{minipage}
}
...
\centerline{\begin{tikzpicture}[scale=0.75]
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,0.000) {一个\emph{字}：由这四个符号组成的任意有限串。这一个是既约的：没有任何方块紧挨着它的配对方块};
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-1.180) {也是一个字，但\emph{不是}既约的：有两对禁止组合，已加深色};
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-2.360) {删掉它们剩下 $aa$，这是既约字，因而是 $F_2$ 的元素};
\end{tikzpicture}
}\par\vspace{3pt}
...
\centerline{\begin{tikzpicture}[scale=0.75]
  ...
  \node[font=\tiny,mkc,anchor=south] at (2.450,0.440) {接缝};
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,0.000) {用 $u=aba^{-1}$ 乘 $v=ab$：一个接一个写下来。只有\emph{接缝}处会产生禁止组合，这里是 $a^{-1}a$};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-0.350)--(-0.5,-0.830);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.000,-1.180) {$a$};
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-1.180) {删掉它：$uv=abb$。再没有可消去的了，因为 $u$ 与 $v$ 本来就既约};
\end{tikzpicture}
}\par\vspace{3pt}
...
\centerline{\begin{tikzpicture}[scale=0.75]
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,0.000) {取 $w=abb$};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-0.350)--(-0.5,-0.830);
  \node[font=\scriptsize,draw=gray,dashed,thick,minimum width=26pt,minimum height=18pt,inner sep=1pt,text=gray] at (0.000,-1.180) {空};
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-1.180) {空字：一个字母也没有};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-1.530)--(-0.5,-2.010);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.000,-2.360) {$a$};
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-2.360) {$w\cdot1$ 与 $1\cdot w$：既没添字母，也没消字母，所以答案还是 $w$};
\end{tikzpicture}
}
\par\vspace{3pt}
\begin{bigpic}
...
\centerline{\begin{tikzpicture}[scale=0.75]
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (6.300,0.000) {$w=abb$ 与 $w^{-1}=b^{-1}b^{-1}a^{-1}$ 相接：次序颠倒，每个字母取逆。中间那一对 $b\,b^{-1}$ 先消};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-0.350)--(-0.5,-0.830);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.000,-1.180) {$a$};
  \node[font=\small,draw=blue!65!black,fill=blue!65!black!45,thick,line width=1.1pt,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.980,-1.180) {$b$};
  \node[font=\small,draw=blue!65!black,fill=blue!65!black!45,thick,line width=1.1pt,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (1.960,-1.180) {$b^{-1}$};
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (6.300,-1.180) {再消去新的中间一对};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-1.530)--(-0.5,-2.010);
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (6.300,-2.360) {再消最后一对：得到空字，所以 $ww^{-1}=1$。$w^{-1}w$ 同样会塌缩};
\end{tikzpicture}
}\par\vspace{3pt}
...
\centerline{\begin{tikzpicture}[scale=0.75]
  ...
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (2.940,0.000) {$a^{-1}$};
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,0.000) {先算 $uv$：$u=ab$ 与 $v=b^{-1}a^{-1}$ 相接，接缝处是 $b\,b^{-1}$};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-0.350)--(-0.5,-0.830);
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-1.180) {再消 $a\,a^{-1}$：于是 $uv=1$};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-1.530)--(-0.5,-2.010);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.000,-2.360) {$a$};
  \node[font=\small,draw=blue!65!black,fill=blue!65!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.980,-2.360) {$b$};
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-2.360) {接上 $w=ab$：$(uv)w=1\cdot ab=ab$};
\end{tikzpicture}
}\par\vspace{1pt}
\centerline{\begin{tikzpicture}[scale=0.75]
  ...
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,0.000) {先算 $vw$：$v=b^{-1}a^{-1}$ 与 $w=ab$ 相接，接缝处是 $a^{-1}a$};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-0.350)--(-0.5,-0.830);
  ...
  \node[font=\small,draw=blue!65!black,fill=blue!65!black!45,thick,line width=1.1pt,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.980,-1.180) {$b$};
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-1.180) {再消 $b^{-1}b$：于是 $vw=1$};
  \draw[-{Stealth[length=3pt]},gray] (-0.5,-1.530)--(-0.5,-2.010);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.000,-2.360) {$a$};
  \node[font=\small,draw=blue!65!black,fill=blue!65!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.980,-2.360) {$b$};
  \node[font=\scriptsize,anchor=west,align=left,text width=150pt] at (5.300,-2.360) {在前面接上 $u=ab$：$u(vw)=ab\cdot1=ab$。答案相同};
\end{tikzpicture}
}\par\vspace{2pt}
\begin{why}
...
\begin{tikzpicture}[scale=0.8,>={Stealth[length=4pt]}]
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.2,0.0) {把 $ab$ 与 $b^{-1}a$ 接起来：$b\,b^{-1}$ 这一对是不允许的};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.2,-1.05) {删掉它：乘积是 $aa$};
\end{tikzpicture}
\par\vspace{8pt}
\raggedright
...
\begin{tikzpicture}[scale=0.8,>={Stealth[length=4pt]}]
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,0.0) {$aba^{-1}b$ 后面接 $b^{-1}ab^{-1}a^{-1}$：\\先消去中间的 $b\,b^{-1}$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-0.35) -- (-0.45,-0.7000000000000001);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-1.05) {$a$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-1.05) {消去 $a^{-1}a$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-2.1) {消去 $b\,b^{-1}$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-3.1500000000000004) {消去 $a\,a^{-1}$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-3.5000000000000004) -- (-0.45,-3.85);
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-4.2) {什么也不剩：空字，即单位元};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
\begin{pitfall}
...
\begin{tikzpicture}[scale=0.8,>={Stealth[length=4pt]}]
  ...
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (4.75,0.0) {$a$};
  \node[font=\scriptsize,anchor=west,align=left] at (6.0,0.0) {先消去第一对 $a\,a^{-1}$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-0.35) -- (-0.45,-0.7000000000000001);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-1.05) {$a$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (6.0,-1.05) {消去 $b\,b^{-1}$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-1.4) -- (-0.45,-1.75);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-2.1) {$a$};
...
\begin{tikzpicture}[scale=0.8,>={Stealth[length=4pt]}]
  ...
  \node[font=\small,draw=mkc,fill=mkc!35,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (3.8,0.0) {$b^{-1}$};
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (4.75,0.0) {$a$};
  \node[font=\scriptsize,anchor=west,align=left] at (6.0,0.0) {先消去 $b\,b^{-1}$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-0.35) -- (-0.45,-0.7000000000000001);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-1.05) {$a$};
  ...
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (2.8499999999999996,-1.05) {$a$};
  \node[font=\scriptsize,anchor=west,align=left] at (6.0,-1.05) {消去 $a^{-1}a$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-1.4) -- (-0.45,-1.75);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-2.1) {$a$};
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.95,-2.1) {$a$};
  \node[font=\scriptsize,anchor=west,align=left] at (6.0,-2.1) {又得到 $aa$};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
\begin{why}
...
\begin{tikzpicture}[scale=0.85,>={Stealth[length=4pt]}]
  ...
  \foreach \y in {0,-0.9,-1.8} \draw[-{Stealth[length=4pt]},mkc,thick] (1.6,\y) -- node[above,font=\tiny,mkc] {奇偶性} (2.9,\y);
...
\begin{tikzpicture}[scale=0.85,>={Stealth[length=4pt]}]
  \node[font=\scriptsize,anchor=west] at (0,0) {$(2\,6)$：一次对换，所以是\textbf{奇}};
  \node[font=\scriptsize,anchor=west] at (0,-0.8) {$(1\,2\,4)(3\,5)=(3\,4)(1\,2)(4\,5)(2\,3)(3\,4)$：五次对换，所以是\textbf{奇}};
  \node[font=\scriptsize,anchor=west] at (0,-1.6) {乘积 $(1\,6\,2\,4)(3\,5)$：四轮换是 3 次对换，二轮换是 1 次，共 4 次，所以是\textbf{偶}};
  \node[font=\scriptsize,anchor=west,mkc] at (0,-2.5) {奇 $\cdot$ 奇 $=$ 偶，即 $\Z/2\Z$ 中的 $1+1=0$：符号与乘法相容 $\checkmark$};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
...
\centering
\begin{tikzpicture}[scale=0.85,>={Stealth[length=4pt]}]
  \node[font=\scriptsize,gray] at (0,1.2) {$N=\{1,r,r^2\}$，即全部旋转};
  \node[font=\scriptsize,gray] at (5.6,1.2) {$sN=\{s,sr,sr^2\}$，即全部反射};
  ...
  \node[font=\scriptsize,align=center] at (2.8,-1.0) {两个陪集，各有 3 个元素；$6=2\cdot3$};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
...
\begin{tikzpicture}[scale=0.78,>={Stealth[length=4pt]}]
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,0.0) {开始：某个字里，$b$ 后面跟着 $a$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-0.35) -- (-0.45,-0.7000000000000001);
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-1.05) {在 $ba$ 前面插入关系子 $aba^{-1}b^{-1}$（这是允许的：它等于 $1$）};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-1.4) -- (-0.45,-1.75);
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-2.1) {这一对 $b^{-1}b$ 消去};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-2.45) -- (-0.45,-2.8000000000000003);
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-3.1500000000000004) {接着 $a^{-1}a$ 消去};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-3.5000000000000004) -- (-0.45,-3.85);
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (8.0,-4.2) {结果：$ba$ 变成了 $ab$};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
\begin{why}
...
\begin{tikzpicture}[scale=0.78,>={Stealth[length=4pt]}]
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.2,0.0) {$\langle a,b\mid aba^{-1}b^{-1}\rangle$ 中的一个字：交换最前面的 $ba$};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-0.35) -- (-0.45,-0.7000000000000001);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-1.05) {$a$};
  \node[font=\small,draw=blue!70!black,fill=blue!70!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.95,-1.05) {$b$};
  \node[font=\small,draw=mkc,fill=mkc!35,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (1.9,-1.05) {$b$};
  \node[font=\small,draw=mkc,fill=mkc!35,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (2.8499999999999996,-1.05) {$a^{-1}$};
  \node[font=\scriptsize,anchor=west,align=left] at (4.2,-1.05) {交换 $b\,a^{-1}$（这条关系子也允许 $a^{-1}$ 越过 $b$）};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-1.4) -- (-0.45,-1.75);
  \node[font=\small,draw=red!80!black,fill=red!80!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-2.1) {$a$};
  \node[font=\small,draw=mkc,fill=mkc!35,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.95,-2.1) {$b$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.2,-2.1) {再交换一次};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-2.45) -- (-0.45,-2.8000000000000003);
  \node[font=\small,draw=mkc,fill=mkc!35,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.0,-3.1500000000000004) {$a$};
  \node[font=\small,draw=mkc,fill=mkc!35,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (0.95,-3.1500000000000004) {$a^{-1}$};
  \node[font=\small,draw=blue!70!black,fill=blue!70!black!12,thick,minimum width=22pt,minimum height=18pt,inner sep=1pt] at (1.9,-3.1500000000000004) {$b$};
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.2,-3.1500000000000004) {现在 $a\,a^{-1}$ 消去};
  \draw[-{Stealth[length=3pt]},gray] (-0.45,-3.5000000000000004) -- (-0.45,-3.85);
  ...
  \node[font=\scriptsize,anchor=west,align=left] at (4.2,-4.2) {整理完毕：$a^0b^2$，即 $\Z^2$ 中的元素 $(0,2)$};
\end{tikzpicture}
\par\vspace{4pt}
\raggedright
...
\par\vspace{4pt}
{\sffamily\bfseries 3. $\Z/n\Z=\langle a\mid a^n\rangle$, in the same style.} With $n=5$: $a^2\cdot a^4=a^6$; delete the relator $a^5$ from $a^6=a^5a$ and get $a$. On the pentagon of Interlude E this is ``2 格 then 4 clicks is 1 click''. Every entry of the multiplication table follows from the single rule $a^5=1$.
\begin{tryit}
...
\centerline{\begin{tikzpicture}[scale=1.0,>={Stealth[length=5pt]},font=\scriptsize]
  \node[draw=big,thick,rounded corners=2pt,fill=big!7,align=center,text width=130pt,inner sep=4pt] (A) at (0,0) {\textbf{一个关于\\几何对象的问题}\\这是哪一个转动？};
  \node[draw=mkc,thick,rounded corners=2pt,fill=mkc!8,align=center,text width=140pt,inner sep=4pt] (B) at (5.6,0) {\textbf{一次机械的计算}\\相乘、约简、整理、计数};
  \node[draw=why,thick,rounded corners=2pt,fill=why!7,align=center,text width=120pt,inner sep=4pt] (C) at (11.2,0) {\textbf{把答案读回来}\\完全不必动用空间想象};
  \draw[->,very thick,mkc] (A)--node[above,font=\tiny,mkc]{翻译过去}(B);
  \draw[->,very thick,mkc] (B)--node[above,font=\tiny,mkc]{再翻译回来}(C);
\end{tikzpicture}
}\par\vspace{4pt}
\begin{minipage}[t]{368pt}\vspace{0pt}
