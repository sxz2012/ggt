...
\begin{bigpic}
\emph{Where this is going.} A group is usually introduced as a set with a multiplication obeying
three rules, which makes it look like a piece of bookkeeping. The point of this chapter is that it
...
\sfig{\label{fig:map}The whole chapter on one page. Read along the orange arrows: a geometric object
gives up its symmetries, those symmetries turn out to obey three rules, and the rest of the chapter
learns to describe such a thing on the left, to compare two of them on the right, and finally to
draw one at the bottom. The dashed arrow is the loop the next office hour closes. Come back to this
picture after each section.}{\figmapone}
