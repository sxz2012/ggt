...
This section is a consolidation, with no new mathematics in it. The map below puts the whole
chapter on one page; the two parts after it say what each idea bought, and what the whole exercise
was for.

\sfig{\label{fig:map}The whole chapter on one page. Read along the orange arrows: a geometric
object gives up its symmetries, those symmetries turn out to obey three rules, and the rest of the
chapter learns to describe such a thing on the left, to compare two of them on the right, and
finally to draw one at the bottom. The dashed arrow is the loop the next office hour closes.}{\figmapone}
